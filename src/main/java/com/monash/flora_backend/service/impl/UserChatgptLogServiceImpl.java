...
//        }
    ...
    public List<String> getWritingSentenceClassification(String writeSentence) {
        ...
        map.add("language", MyConstant.resolveLanguageByCourseId(courseId));
    ...
    @Override
    public List<List<String>> batchWritingSentenceClassification(List<String> writeSentenceList, String courseId) {
        String url = MyConstant.CHAT_SERVICE_URL + "/copes-classify-sentence-direct-result";
        HttpHeaders headers = new HttpHeaders();
        headers.setContentType(MediaType.APPLICATION_FORM_URLENCODED);
...
//            JSONUtil.parseArray(result);
            ...
            log.error("batchWritingSentenceClassification 调用下游失败, sentences: {}", writeSentenceList, e);
            throw new RuntimeException("Failed to batch classify sentences", e);
        }
