...
//    }
    ...
    /*@Override
    public List<MdlQuizVO> getQuizResponseByUserIdAndCourseIdListAndQuizName(String quizName, List<String> courseIdList, Long userId) {
        return getBaseMapper().getQuizResponseByUserIdAndCourseIdListAndQuizName(quizName, courseIdList, userId);
    }*/
