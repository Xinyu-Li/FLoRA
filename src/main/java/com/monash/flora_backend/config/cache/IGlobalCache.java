...
// ============================String=============================
     ...
     * @return
     */
    boolean lSetAll(String key, List<String> value);
     ...
     * @return
     */
    boolean lSetAll(String key, List<String> value, long time);
    ...
    boolean rSet(String key, String value);
    ...
    boolean rSet(String key, String value, long time);
     ...
     * @return
     */
    boolean rSetAll(String key, List<String> value);
     ...
     * @return
     */
    boolean rSetAll(String key, List<String> value, long time);
    ...
    void addOrderedEvent(String key, String event, double score, long time);
    Set<String> getOrderedEvent(String key, long start, long end);
     ...
     * @return
     */
    Set<String> getElementsByScore(String key, double score);

    Set<String> getElementsGreaterThanScore(String key, double score);

    long getOrderedEventSize(String key);
    Set<ZSetOperations.TypedTuple<String>> getOrderedTuple(String key, long start, long end);
}
