...
public class MyConstantCopesModelSRLPattern {
    ...
    public static String PRIORITY1_CPI1 = "\\d+--OPEN_ESSAY=====\\d+--WRITE_ESSAY=====\\d+--CLOSE_ESSAY=====(?:\\d+--OPEN_ESSAY=====)+(?:\\d+--CLOSE_ESSAY=====)+";
...
//    public static String PRIORITY2_CMTR1 = "(\\d+--(?:WRITE_ESSAY|OPEN_ESSAY)=====)?(?:\\d+--(?:TASK_REQUIREMENT|RUBRIC)=====)+";
    ...
    public static String PRIORITY2_SASBTS3 = "\\d+--(?:WRITE_ESSAY|OPEN_ESSAY|READ_ANNOTATION)=====(?:\\d+--RUBRIC_(?:RE)?READING=====)+"; // TODO： 这里的rubric后面应该去掉reading
    public static String PRIORITY2_SSSRPP1 = "\\d+--(?:WRITE_ESSAY|OPEN_ESSAY)=====(?:\\d+--FEEDBACK_TOOLKIT=====)+";//5分钟之后detect
...
//    public static String PRIORITY3_OA1 = "";
//    public static String PRIORITY3_OA2 = "";
//    public static String PRIORITY3_OA3 = "";
//    public static String PRIORITY3_OR1 = "";
//    public static String PRIORITY3_OR2 = "";
//    public static String PRIORITY3_OR3 = "";
//    public static String PRIORITY3_OT1 = "";
//    public static String PRIORITY3_OT2 = "";
