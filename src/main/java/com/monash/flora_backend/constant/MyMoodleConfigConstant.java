...
//    );
    ...
    public static void setNeedTraceCourseIds(String... courseIds) {
        NEED_TRACE_COURSE_ID_LIST = Arrays.stream(courseIds)
    ...
    public static void setNeedTraceCourseIdGroups(String[]... courseIdGroups) {
        NEED_TRACE_COURSE_ID_LIST = Arrays.stream(courseIdGroups)
                .filter(Objects::nonNull)
