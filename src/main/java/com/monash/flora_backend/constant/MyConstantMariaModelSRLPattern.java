...
//    public static String PRIORITY3_MCE3 = "(?:\\d+--(?:WRITE_ESSAY|OPEN_ESSAY)=====)?(?:\\d+--CHECKLIST=====)+";
    public static String PRIORITY3_MCE3 = "(?:\\d+--(?:READ_ESSAY|WRITE_ESSAY(?:_[^=]+)?|OPEN_ESSAY)=====)?(?:\\d+--CHECKLIST=====)+";
...
//    public static String PRIORITY10_MCO4 = "\\d+--(?:TASK_REQUIREMENT|RUBRIC)=====(?:\\d+--(?:PAGE_NAVIGATION|TABLE_OF_CONTENT)=====)+(?:\\d+--(?:TASK_REQUIREMENT|RUBRIC)=====)?";
    ...
    public static String PRIORITY16_HCEO2 = "\\d+--(?:TASK_REQUIREMENT|RUBRIC)=====(?:\\d+--(?:PAGE_NAVIGATION|TABLE_OF_CONTENT)=====)*(?:\\d+--OPEN_ESSAY=====)?(?:\\d+--(?:READ_ESSAY|WRITE_ESSAY(?:_[^=]+)?)=====)+(?:\\d+--CLOSE_ESSAY=====)?";
//    public static String PRIORITY17_HCEO1 = "\\d+--\\w{8,10}_REREADING=====(?:\\d+--(?:PAGE_NAVIGATION|TABLE_OF_CONTENT)=====)*(?:\\d+--OPEN_ESSAY=====)?(?:\\d+--(?:IR)?RELEVANT_(?:RE)?READING=====)*(?:\\d+--WRITE_ESSAY=====)+(?:\\d+--CLOSE_ESSAY=====)?";
    public static String PRIORITY17_HCEO1 = "\\d+--\\w{8,10}_REREADING=====(?:\\d+--(?:PAGE_NAVIGATION|TABLE_OF_CONTENT)=====)*(?:\\d+--OPEN_ESSAY=====)?(?:\\d+--(?:IR)?RELEVANT_(?:RE)?READING=====)*(?:\\d+--(?:READ_ESSAY|WRITE_ESSAY(?:_[^=]+)?)=====)+(?:\\d+--CLOSE_ESSAY=====)?";
...
//    public static String PRIORITY30_HCEO3 = "(?:\\d+--WRITE_ESSAY=====)+(?:\\d+--CLOSE_ESSAY=====)?";
    ...
    //after discussion with joep
    public static String PRIORITY30_HCEO3 = "(?:\\d+--(?:READ_ESSAY|WRITE_ESSAY(?:_[^=]+)?)=====)+(?:\\d+--CLOSE_ESSAY=====)?(?:\\d+--(?:IR)?RELEVANT_(?:RE)?READING=====)*";
