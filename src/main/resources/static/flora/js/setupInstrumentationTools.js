...
//                }, 2000);
            ...
            if (typeof useQuizConfidenceTool !== 'undefined' && useQuizConfidenceTool) {
                setupQuizConfidenceTool();
            }
            if (typeof useMetaJudgementsTool !== 'undefined' && useMetaJudgementsTool) {
                setupMetaJudgementsTool();
            }
