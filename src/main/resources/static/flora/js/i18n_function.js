...
[[نهاية مهمتك]]`,
        ...
        "gpt-scaffold-test-mai-name": ".النشاط 3: التفكير في طريقة تعلمك",
        "gpt-scaffold-test-isdimu-name": "النشاط ٣: المعرفة في تكتيكات التعلم",
        "gpt-scaffold-pretest-name": "النشاط 2: ماذا تعرف عن مصادر الطاقة المتجددة؟",
        "gpt-scaffold-check-take-previous-study-name": ".النشاط 1: تحدث عن نفسك",
...
[[KONEC VAŠEHO ÚKOLU]]`,
        ...
        "gpt-scaffold-test-mai-name": "Aktivita 3: Zamyšlení se nad svým učením",
        "gpt-scaffold-test-isdimu-name": "Aktivita 3: ISDIMU",
        "gpt-scaffold-pretest-name": "Aktivita 2: Kolik toho víš o obnovitelných zdrojích energie?",
        "gpt-scaffold-check-take-previous-study-name": "Aktivita 1: O sobě",
...
Die Schüler:in arbeitet an einer individuellen Aufsatzaufgabe.
...
Grundlegend (1) Häufige Fehler; Ideen sind schwer nachvollziehbar oder nicht schlüssig.
...
`,
        ...
        "gpt-scaffolding-title": "Instruktionsfeld",
        "planner-title": "Planungswerkzeug",
        "planner-learning-strategy-select-label-text": "1. Bitte erstelle einen Plan für deine Lernstrategie:",
        ...
        "essay-title": "Werkzeug zum Schreiben von Aufsätzen",
        ...
        "gpt-scaffold-user-take-pre-study-prompt": "Diese Schülerin / dieser Schüler hat an einer vorherigen Studie teilgenommen, die dieselbe Plattform nutzte, und verfügt daher über ein gewisses Maß an Aufgabenwissen.",
        "gpt-scaffold-isdimu-prompt-0": "",
        "gpt-scaffold-isdimu-prompt-16": "",
        "gpt-scaffold-isdimu-prompt-32": "",
        "gpt-scaffold-pretest-grades-prompt-0": "Diese Schülerin/ dieser Schüler verfügt über ein hohes Maß an Wissen über erneuerbare Energie.",
        "gpt-scaffold-pretest-grades-prompt-5": "Diese Schülerin/ dieser Schüler verfügt über geringe Kenntnisse über erneuerbare Energie.",
        "gpt-scaffold-pretest-grades-prompt-10": "Diese Schülerin/ dieser Schüler verfügt über mittlere Kenntnisse über erneuerbare Energie.",
        "gpt-scaffold-mai-knowledge-cognition-prompt-0": "Diese Schülerin/ dieser Schüler versteht, wie man am besten lernt, und können gute Strategien für das Lernen wählen.",
        "gpt-scaffold-mai-knowledge-cognition-prompt-21": "Diese Schülerin/ dieser Schüler weiß nicht genau, was beim Lernen hilft und welche Strategien am besten geeignet sind.",
        "gpt-scaffold-mai-knowledge-cognition-prompt-33": "Diese Schülerin/ dieser Schüler hat ein gewisses Verständnis dafür, wie man effektiv lernt, und können einige hilfreiche Strategien nennen.",
        "gpt-scaffold-mai-regulation-cognition-prompt-0": "Diese Schülerin/ dieser Schüler plant, reflektiert über und passt den Lernprozess an, um bessere Ergebnisse zu erzielen.",
        "gpt-scaffold-mai-regulation-cognition-prompt-21": "Diese Schülerin/ dieser Schüler plant nicht im Voraus und verfolgen den eigenen Lernfortschritt während der Arbeit nicht.",
        "gpt-scaffold-mai-regulation-cognition-prompt-33": "Diese Schülerin/ dieser Schüler achtet während der Durchführung der Aufgaben ein wenig auf die Planung und Überprüfung des Lernprozesses.",
        "gpt-scaffold-test-mai-name": "Aktivität 3: Über deine eigenen Lernprozesse reflektieren",
        "gpt-scaffold-test-isdimu-name": "",
        "gpt-scaffold-pretest-name": "Aktivität 2: Wie viel weißt du über erneuerbare Energie?",
        "gpt-scaffold-check-take-previous-study-name": "Aktivität 1 (TUM): Über dich",
        "gpt-scaffold-planner-select-prompt-1": "Diese Schülerin/ dieser Schüler hat für diese Aufgabe den Plan [zuerst lesen, dann schreiben] entwickelt.",
        "gpt-scaffold-planner-select-prompt-2": "Diese Schülerin/ dieser Schüler hat sich für diese Aufgabe den Plan ausgedacht, [gleichzeitig zu lesen und zu schreiben].",
        "gpt-scaffold-planner-select-prompt-3": "Diese Schülerin/ dieser Schüler hat sich für diese Aufgabe den Plan ausgedacht, [intensiv zu schreiben und selektiv zu lesen].",
        "gpt-scaffold-planner-select-prompt-4": "Diese Schülerin/ dieser Schüler hat sich für diese Aufgabe den Plan ausgedacht, [seinen eigenen Plan].",
        "gpt-scaffold-need-check-subaction-prompt-SAVE_PLANNER-not-exist": "Diese Schülerin / dieser Schüler hat keine konkreten Pläne erstellt, wie sie/ er die Aufgabe angehen will.",
        "gpt-scaffold-need-check-subaction-prompt-SAVE_PLANNER-exist": "Diese Schülerin/ dieser Schüler hat konkrete Pläne zur Durchführung der Aufgabe erstellt.",
        "gpt-scaffold-need-check-subaction-prompt-TIMER-not-exist": "Diese Schülerin/ dieser Schüler ist sich der verbleibenden Zeit zur Erledigung der Aufgabe nicht bewusst.",
        "gpt-scaffold-need-check-subaction-prompt-TIMER-exist": "Diese Schülerin/ dieser Schüler ist sich der verbleibenden Zeit zur Erledigung der Aufgabe bewusst.",
        "gpt-scaffold-need-check-subaction-prompt-TRY_OUT_TOOLS-not-exist": "Diese Schülerin/ dieser Schüler ist sich nicht bewusst, welche Hilfsmittel in der Umgebung zur Verfügung stehen, die bei der Erledigung der Aufgabe helfen könnten.",
        "gpt-scaffold-need-check-subaction-prompt-TRY_OUT_TOOLS-exist": "Diese Schülerin/ dieser Schüler ist sich der in der Umgebung verfügbaren Hilfsmittel bewusst, die bei der Erledigung der Aufgabe helfen können.",
        "gpt-scaffold-need-check-subaction-prompt-PAGE_NAVIGATION-not-exist": "Diese Schülerin/ dieser Schüler ist sich der verfügbaren Lesematerialien, die bei der Aufgabe helfen könnten, nicht bewusst.",
        "gpt-scaffold-need-check-subaction-prompt-PAGE_NAVIGATION-exist": "Diese Schülerin/ dieser Schüler ist sich der verfügbaren Lesematerialien bewusst, die bei der Aufgabe helfen könnten.",
        "gpt-scaffold-need-check-subaction-prompt-RUBRIC-not-exist": "Diese Schülerin/ dieser Schüler ist sich über die Bewertungskriterien nicht bewusst.",
        "gpt-scaffold-need-check-subaction-prompt-RUBRIC-exist": "Diese Schülerin/ dieser Schüler ist sich über die Bewertungskriterien bewusst.",
        "gpt-scaffold-need-check-subaction-prompt-TASK_REQUIREMENT-not-exist": "Diese Schülerin/ dieser Schüler ist sich über die Aufgabenstellung nicht bewusst.",
        "gpt-scaffold-need-check-subaction-prompt-TASK_REQUIREMENT-exist": "Diese Schülerin/ dieser Schüler ist sich über die Aufgabenstellung bewusst.",
...
[[End of Your Task]]`,
        ...
        "gpt-scaffold-test-mai-name": "Activity 3: Reflecting On Your Learning",
        "gpt-scaffold-test-isdimu-name": "Activity 3: ISDIMU",
        "gpt-scaffold-pretest-name": "Activity 2: How much do you know about renewable energy?",
...
`,
        ...
        "gpt-scaffold-test-mai-name": "Actividad 3: Refleccionando sobre tu aprendizaje",
        "gpt-scaffold-test-isdimu-name": "Actividad 3: conocimiento en tácticas de aprendizaje",
        "gpt-scaffold-pretest-name": "Actividad 2: ¿Qué tanto sabes sobre energías renovables?",
        "gpt-scaffold-check-take-previous-study-name": "Actividad 1: Sobre ti",
...
Lopuksi, palautteen SAA OLLA enintään 70 sanaa!
...
`,
        ...
        "gpt-scaffold-check-take-previous-study-name": "Tehtävä 1: Kerro itsestäsi",
        ...
        "gpt-scaffold-toolbar-btn-hint": "Hoksautusikkuna",
        ...
        "gpt-scaffold-tool-data-label": "Tekoälyagentti",
        "process-visual-tool-data-label": "",
        "essay-product-visual-tool-data-label": "",
        "collaborate-writing-tool-data-label": "",
        ...
        "checklist-tool-data-label": "",
        "multi-agents-single-window-tool-data-label": "Tekoälyagentti",
        "dictionary-tool-data-label": "",
...
[[Akhir Tugas Anda]]`,
        ...
        "gpt-scaffold-test-mai-name": "Aktivitas 3: Merefleksikan Pembelajaran Anda.",
        "gpt-scaffold-test-isdimu-name": "Kegiatan 3: ISDIMU",
        "gpt-scaffold-pretest-name": "Aktivitas 2: Seberapa banyak yang Kamu ketahui tentang energi terbarukan?",
        "gpt-scaffold-check-take-previous-study-name": "Aktivitas 1: Tentang dirimu.-------------",
...
[[Tamat Tugasan Anda]]`,
        ...
        "scaffolding-chat-open-text": "Buka Sembang",
        "gpt-scaffolding-title": "Panel Arahan",
        "planner-title": "Alat Perancang",
        "planner-learning-strategy-select-label-text": "1. Sila sediakan pelan untuk strategi pembelajaran anda.",
        "planner-learning-strategy-select-option1-text": "Pilih strategi",
        "planner-learning-strategy-select-customise-option-text": "Gunakan strategi sendiri",
        "planner-add-more-customise-strategy-btn-text": "Tambah Strategi",
        "planner-customise-option-hint-textarea-placeholder": "Jelaskan mengapa anda merancang seperti ini?",
        ...
        "gpt-scaffold-test-mai-name": "Aktiviti 3: Refleksi Terhadap Pembelajaran Anda",
        "gpt-scaffold-test-isdimu-name": "",
        "gpt-scaffold-pretest-name": "Aktiviti 2: Sejauh manakah pengetahuan anda tentang tenaga boleh diperbaharui?",
        "gpt-scaffold-check-take-previous-study-name": "Aktiviti 1: Mengenai diri anda",
...
`,
        ...
        "gpt-scaffold-role-description": "",
        "planner-customise-step2-instruction": `Sila terangkan secara terperinci strategi pembelajaran yang anda rancang untuk gunakan dan bagaimana anda akan membahagikan masa anda. Anda juga boleh menyertakan sebab bagi strategi dan pembahagian masa tersebut.`,
        ...
        "multi-agents-send-btn-text": "Ctrl+Enter",
        "annotation-toolbar-btn-hint": "Panel Anotasi",
        "annotation-search-toolbar-btn-hint": "Alat Carian Anotasi",
        ...
        "annotation-tool-data-label": "Alat Anotasi",
        "search-annotation-tool-data-label": "Alat Carian Anotasi",
        ...
        "multi-agents-single-window-tool-data-label": "Alat Chatbot",
        "dictionary-tool-data-label": "",
        "timer-tool-data-label": "Alat Pemasa",
        "questionnaire-tool-data-label": "",
        "chat-reminder-message": `
Chatbot ini kini tersedia untuk anda. Anda tidak boleh menggunakan chatbot ini untuk menulis esei anda.`,
    ...
    nl: {
        "gpt-scaffold-prompt-template-groupA": "",
        "gpt-scaffold-prompt-template-groupB": `[[Start van de opdrachtinstructies]]

Een student werkt aan een essayopdracht.

Het volgende is de opdrachtinstructie:

Onderwerp van de opdracht: Strategie voor hernieuwbare energie voor een noordelijke kustgemeenschap

Je bent ingehuurd als energiedeskundige om advies te geven aan een noordelijke kustgemeenschap die in de buurt van bergen ligt en te maken heeft met strenge winters met veel sneeuw. Deze gemeenschap is momenteel sterk afhankelijk van geïmporteerde fossiele brandstoffen. Deze zijn duur, schadelijk voor het milieu en onbetrouwbaar tijdens zware winterstormen. De stad zoekt een oplossing die het hele jaar door een stabiele energievoorziening garandeert, op termijn kosten bespaart en idealiter lokale werkgelegenheid creëert. Het gebied kent een constante zeewind en ligt in de buurt van belangrijke bosbestanden die duurzaam worden beheerd. Het beschermen van het lokale zeeleven en de bosomgeving is echter een prioriteit voor de gemeenschap. 
Jouw opdracht:

Schrijf een kort plan waarin je een doordachte strategie voor hernieuwbare energie adviseert, waarin twee soorten hernieuwbare energie worden gecombineerd. Motiveer je advies duidelijk door het volgende te bespreken:
Hoe elke hernieuwbare energiebron past bij de lokale omgeving, klimaatuitdagingen en energiebehoeften.
Het financiële aspect en wat de verwachte economische voordelen zijn, waaronder het creëren van banen.
Mogelijke effecten op het milieu en hoe jouw strategie de gevaren voor bossen en zeeleven vermindert.

Deze taak heeft een tijdslimiet van 45 minuten. 

Hieronder volgt de rubriek die aan de student wordt verstrekt:

Deze rubriek wordt gebruikt om je essay te beoordelen. 

Het essay bestaat uit 200 tot 300 woorden. 
Je mag NIET rechtstreeks kopiëren uit het leesmateriaal of uit andere bronnen - het essay moet in je eigen woorden worden geschreven.

De onderstaande tabel is de volledige beoordelingsrubriek:

1. Het bespreken van de gekozen energiebronnen:
   Uitstekend (3): Combineert duidelijk twee soorten energie en geeft redenen voor beide.
   Goed (2): Noemt twee soorten energie, maar geeft weinig uitleg.
   Basis (1): Slechts één soort energie, of onduidelijke oplossing; weinig of geen uitleg.

2. Gebruik van geografische en klimatologische details:
   Uitstekend (3): Legt duidelijk uit hoe beide soorten energie passen bij de lokale geografie en het lokale klimaat.
   Goed (2): Geeft enkele details over de lokale geografie/het lokale klimaat, maar legt geen verband met de energiekeuze.
   Basis (1): Weinig of geen gebruik van lokale details; energiekeuzes passen niet bij het scenario.

3. Economische voordelen en voordelen voor de werkgelegenheid:
   Uitstekend (3): Sterke uitleg over hoe het plan geld bespaart en lokale banen creëert.
   Goed (2): Vermeldt geld of banen, maar geeft weinig details.
   Basis (1): Vermeldt geen geld of banen, of geeft onjuiste informatie.

4. Milieubescherming:
   Uitstekend (3): Legt duidelijk uit hoe het plan bossen en zeeën beschermt; geeft specifieke manieren om risico's te vermijden.
   Goed (2): Vermeldt de impact op het milieu, maar geeft weinig details over bescherming.
   Basis (1): Vermeldt het milieu nauwelijks of niet, of negeert risico's voor de natuur.

5. Kwaliteit van het schrijven:
   Uitstekend (3): Het schrijven is duidelijk, zonder grammaticale fouten of spelfouten. De ideeën volgen elkaar logisch op.
   Goed (2): Enkele grammaticale fouten of spelfouten maken de ideeën minder duidelijk. De betekenis is soms onduidelijk.
   Basis (1): Veelvuldige grammaticale fouten of spelfouten; ideeën zijn moeilijk te volgen of niet samenhangend.

[[Einde van de taakinstructies]]
...
[[Begin van de taak]]
    ...
    Maak gebruik van het effectieve feedbackkader om deze feedback te geven. Dit is specifiek gericht op leren en bevat de volgende drie belangrijke onderdelen. 

1. Gebaseerd op de hierboven benoemde leeromstandigheden en er wordt gebruik gemaakt van zowel de sterke als zwakke punten van de prestaties van de leerling.
2. Gefocused op de impact ervan door opmerkingen te geven met bruikbare informatie die de leerling helpt de leerresultaten voor de taak te behalen. Dit moet voortkomen uit het hierboven benoemde advies.
3. Helpt de leerling om grip te krijgen op diens leerproces, besteedt aandacht aan diens sociale, emotionele en motivationele behoeften en moedigt hen aan om open te staan voor evaluatieve opmerkingen.

Houd rekening met het volgende:

Probeer zo goed mogelijk te voorkomen dat je gedetailleerde instructies geeft over wat er precies in het essay moet staan.

Zorg ervoor dat je alleen de feedbacktekst teruggeeft!

Ten slotte mag de feedback NIET langer zijn dan 100 woorden!

[[Einde van de taak]]`,
        "gpt-scaffold-prompt-template-groupC": `[[Start van de opdrachtinstructies]]
...
[[Einde van de taak]]`,
        "gpt-scaffold-need-check-srl-prompt-CMTC1": `Tot nu toe in de leersessie hebben leerlingen die goed presteerden in deze taak ervoor gezorgd dat ze zich bewust waren van de tijdslimiet voor de taak door gebruik te maken van de aangeboden timer. Dit lijkt niet het geval te zijn bij deze leerling. Kun je de leerling feedback geven in de vorm van een alinea (gebruik geen opsommingstekens of genummerde lijsten) over hoe die diens tijd beter in de gaten kan houden door gebruik te maken van de aangeboden timer (de tijdsknop in de werkbalk met een kloksymbool)? Houd daarbij rekening met alle volgende leeromstandigheden van deze leerling: `,
        "gpt-scaffold-need-check-srl-prompt-CMTR": `Tot nu toe in de leersessie hebben leerlingen die goed presteerden in deze opdracht ervoor gezorgd dat ze teruggrijpen op de opdrachtinstructies en de beoordelingsrubriek om hun conceptessay te evalueren en te controleren of hun schrijfwerk overeenkomt met de opdrachtvereisten en de beoordelingsrubriek. Dit lijkt niet het geval te zijn bij deze leerling. Kun je de leerling feedback geven in de vorm van een alinea (gebruik geen opsommingstekens en genummerde lijsten) over het gebruik van de informatie uit de opdrachtinstructies en beoordelingsrubriek om hun essayontwerp te evalueren en te controleren of hun schrijfontwerp goed aansluit bij de opdrachtvereisten en beoordelingsrubriek. Probeer GEEN gedetailleerde instructies te geven over wat er in het essay moet worden opgenomen. Houd ondertussen rekening met alle volgende leeromstandigheden van deze leerling:`,
        ...
        "gpt-scaffold-need-check-srl-prompt-CSTR2": `Tot nu toe in de leersessie zorgden leerlingen die goed presteerden bij deze taak ervoor dat ze de opdrachtinstructies en de beoordelingsrubriek duidelijk begrepen. Dit lijkt bij deze leerling niet het geval te zijn. Kun je de leerling feedback geven in de vorm van een alinea (gebruik geen opsommingstekens en genummerde lijsten) over hoe die diens begrip van de opdrachtinstructies en de beoordelingsrubriek kan verbeteren, zodat die zich ervan bewust wordt dat die diens essay moet afstemmen op de opdrachtinstructies en de beoordelingsrubriek? Probeer GEEN gedetailleerde instructies te geven over wat er in het essay moet worden opgenomen. Houd daarbij rekening met alle volgende leeromstandigheden van deze leerling:`,
        "gpt-scaffold-need-check-srl-prompt-STR-MTC": `Tot nu toe in de leersessie hebben leerlingen die goed presteerden bij deze taak ervoor gezorgd dat ze zich bewust waren van de tijdslimiet of de taak door gebruik te maken van de aangeboden timer, en tegelijkertijd begrepen ze duidelijk de opdrachtinstructies en de beoordelingsrubriek. Dit lijkt niet het geval te zijn bij deze leerling. Kun je de leerling feedback geven in de vorm van een alinea (gebruik geen opsommingstekens en genummerde lijsten) waarin je advies geeft over al deze punten, over hoe die diens tijd beter in de gaten kan houden door gebruik te maken van de aangeboden timer (de tijdsknop in de werkbalk met een kloksymbool), en over hoe die diens begrip van de taakinstructies en de beoordelingsrubriek kan verbeteren? Probeer de leerling te ondersteunen in diens zelfbewustzijn om het schrijven van het essay af te stemmen op de opdrachtinstructies en de beoordelingsrubriek. Probeer daarnaast ook om GEEN gedetailleerde instructies te geven over wat er in het essay moet worden opgenomen. Houd ondertussen rekening met alle volgende leeromstandigheden van deze leerling:`,
        ...
        "gpt-scaffold-need-check-srl-prompt-OT2": `Tot nu toe in de leersessie hebben leerlingen die goed presteerden in deze opdracht ervoor gezorgd dat ze ideeën in hun eigen woorden uitlegden op basis van het leesmateriaal. Dit lijkt niet het geval te zijn bij deze leerling. Kun je de leerling feedback geven in de vorm van een alinea (gebruik geen opsommingstekens en genummerde lijsten) over het belang van het uitleggen van ideeën in hun eigen woorden, gebaseerd op het leesmateriaal? Probeer GEEN gedetailleerde instructies te geven over wat er in het essay moet worden opgenomen. Houd daarbij rekening met alle volgende leeromstandigheden van deze leerling:`,
        "annotation-notes-title": "Notitie paneel",
        "annotation-notes-delete-confirm-message": "Wil je dit verwijderen?",
        ...
        "scaffolding-chat-open-text": "Chat open",
        "gpt-scaffolding-title": "Instructiepaneel",
        "planner-title": "Planningstool",
        "planner-learning-strategy-select-label-text": "1. Maak een plan voor jouw leerstrategie:",
        "planner-learning-strategy-select-option1-text": "Selecteer een strategie",
        "planner-learning-strategy-select-customise-option-text": "Gebruik je eigen strategie",
        "planner-add-more-customise-strategy-btn-text": "Voeg meer strategie toe",
        "planner-customise-option-hint-textarea-placeholder": "Leg uit waarom je dit plan hebt gemaakt.",
        "planner-next-btn-text": "Volgende",
        "planner-time-unit-minute": "Minuten",
        "planner-display-plan-title": "Mijn leerplanning",
        "planner-display-overall-strategy-label": "Algemene strategie:",
        "planner-display-time-allocation-label": "Tijdsbesteding:",
        "planner-display-writing-strategy-label": "Schrijfstrategie:",
        "planner-display-reading-strategy-label": "Leesstrategie:",
        "planner-customise-plan-reason-placeholder": "(Optioneel)",
        "essay-title": "Essay schrijftool",
        "essay-save-btn-text": "Essay opslaan",
        ...
        "gpt-scaffold-user-take-pre-study-prompt": "Deze leerling heeft deelgenomen aan het eerdere onderzoek, dus die heeft een bepaald niveau van kennis over de opdracht.",
        ...
        "gpt-scaffold-pretest-grades-prompt-0": "Deze leerling heeft een hoog kennisniveau over hernieuwbare energie.",
        "gpt-scaffold-pretest-grades-prompt-5": "Deze leerling heeft een laag kennisniveau over hernieuwbare energie.",
        "gpt-scaffold-pretest-grades-prompt-10": "Deze leerling heeft een gemiddeld kennisniveau over hernieuwbare energie.",
        "gpt-scaffold-mai-knowledge-cognition-prompt-0": "Deze student weet goed wat hen helpt bij het leren en welke strategieën voor hen het beste werken.",
        "gpt-scaffold-mai-knowledge-cognition-prompt-21": "Deze student weet niet goed wat hen helpt bij het leren en welke strategieën voor hen het beste werken.",
        "gpt-scaffold-mai-knowledge-cognition-prompt-33": "Deze student weet een beetje wat hen helpt bij het leren en welke strategieën voor hen het beste werken.",
        "gpt-scaffold-mai-regulation-cognition-prompt-0": "Deze leerling plant, monitort en past diens leerproces aan om beter te presteren.",
        "gpt-scaffold-mai-regulation-cognition-prompt-21": "Deze leerling plant niet vooruit of houdt tijdens het werken geen overzicht bij van diens leerproces.",
        "gpt-scaffold-mai-regulation-cognition-prompt-33": "Deze leerling besteedt enige aandacht aan het plannen het checken van diens leerproces tijdens de opdrachten.",
        "gpt-scaffold-test-mai-name": "Opdracht 3: Reflecteren op je leerproces",
        "gpt-scaffold-test-isdimu-name": "Activiteit 3: kennis van leertactieken",
        "gpt-scaffold-pretest-name": "Opdracht 2: Hoeveel weet je over hernieuwbare energie?",
        "gpt-scaffold-check-take-previous-study-name": "Opdracht 1: Over jezelf",
        "gpt-scaffold-planner-select-prompt-1": "Deze leerling heeft voor deze opdracht het plan bedacht om eerst te lezen en dan te schrijven. ",
        "gpt-scaffold-planner-select-prompt-2": "Deze leerling heeft voor deze opdracht het plan bedacht om tegelijkertijd te lezen en te schrijven. ",
        "gpt-scaffold-planner-select-prompt-3": "Deze leerling heeft voor deze opdracht het plan bedacht om uitvoerig te gaan schrijven en selectief te lezen. ",
        "gpt-scaffold-planner-select-prompt-4": "",
        "gpt-scaffold-need-check-subaction-prompt-SAVE_PLANNER-not-exist": "Deze leerling heeft geen expliciete plannen gemaakt voor hoe die de opdracht gaat uitvoeren.",
        "gpt-scaffold-need-check-subaction-prompt-SAVE_PLANNER-exist": "Deze leerling heeft voor deze opdracht een expliciet plan bedacht. ",
        "gpt-scaffold-need-check-subaction-prompt-TIMER-not-exist": "Deze leerling is zich niet bewust van de tijd die nog over is om de opdracht af te maken.",
        "gpt-scaffold-need-check-subaction-prompt-TIMER-exist": "Deze leerling is zich bewust van de tijd die nog over is om de opdracht af te maken.",
        "gpt-scaffold-need-check-subaction-prompt-TRY_OUT_TOOLS-not-exist": "Deze leerling is zich niet bewust van de beschikbare tools in de leeromgeving die kunnen helpen de opdracht af te maken.",
        "gpt-scaffold-need-check-subaction-prompt-TRY_OUT_TOOLS-exist": "Deze leerling is zich bewust van de beschikbare tools in de leeromgeving die kunnen helpen de opdracht af te maken.",
        "gpt-scaffold-need-check-subaction-prompt-PAGE_NAVIGATION-not-exist": "Deze leerling is zich niet bewust van het beschikbare leesmateriaal in de leeromgeving dat hen kan helpen met de opdracht.",
        "gpt-scaffold-need-check-subaction-prompt-PAGE_NAVIGATION-exist": "Deze leerling is zich bewust van het beschikbare leesmateriaal in de leeromgeving dat hen kan helpen met de opdracht.",
        "gpt-scaffold-need-check-subaction-prompt-RUBRIC-not-exist": "Deze leerling is zich niet bewust van de beoordelingsrubriek.",
        "gpt-scaffold-need-check-subaction-prompt-RUBRIC-exist": "Deze leerling is zich bewust van de beoordelingsrubriek.",
        "gpt-scaffold-need-check-subaction-prompt-TASK_REQUIREMENT-not-exist": "Deze leerling is zich niet bewust van de opdrachtinstructies.",
        "gpt-scaffold-need-check-subaction-prompt-TASK_REQUIREMENT-exist": "Deze leerling is zich bewust van de opdrachtinstructies.",
        "gpt-scaffold-role-description": "Je bent een behulpzame assistent, geef suggesties op basis van de gegeven tekst.",
        "planner-customise-step2-instruction": "Beschrijf in detail de leerstrategie die je van plan bent toe te passen en hoe je je tijd gaat indelen. Je kunt ook de redenen voor de strategie en tijdsindeling benoemen.",
        "planner-reading-strategy-1": "Lees het materiaal pagina voor pagina",
        "planner-reading-strategy-2": "Kort scannen en daarna grondig lezen",
        "planner-reading-strategy-3": "Gebruik de markeertool om de belangrijkste informatie te markeren",
        "planner-reading-strategy-4": "Mijn bevindingen tijdens het lezen als notities opschrijven ",
        "planner-reading-strategy-5": "Vraaggestuurd lezen met een focus op specifieke informatie",
        "planner-reading-strategy-6": "Selectief lezen en irrelevante informatie overslaan",
        "planner-reading-strategy-instruction": "Welke leesvaardigheden ben je van plan te gebruiken (meerdere keuzes mogelijk)?",
        "planner-writing-strategy-1": "Maak eerst een opzet voor de structuur van je essay en vul deze vervolgens in met details.",
        "planner-writing-strategy-2": "Gebruik mijn aantekeningen en markeringen bij het schrijven van het essay.",
        "planner-writing-strategy-3": "Herzien van de instructies en beoordelingstabel om mijn schrijfwerk ermee op één lijn te krijgen",
        "planner-writing-strategy-4": "Kopiëren en plakken van zinnen en ze daarna herschrijven",
        "planner-writing-strategy-5": "Gebruik het schrijfkader en de patronen die ik heb geleerd om te schrijven.",
        "planner-writing-strategy-instruction": "Welke schrijfvaardigheden ben je van plan te gebruiken (meerdere opties mogelijk)?",
        "planner-main-strategy-1": "Eerst lezen dan schrijven",
        "planner-main-strategy-1-instruction": "Hoeveel tijd ben je van plan te besteden aan het lezen en schrijven? ",
        "planner-main-strategy-1-task-1": "2.1 Tijd zal worden besteed aan lezen",
        "planner-main-strategy-1-task-2": "2.1 Tijd zal worden besteed aan schrijven",
        "planner-main-strategy-2": "Tegelijkertijd lezen en schrijven",
        "planner-main-strategy-2-instruction": "Hoeveel tijd ben je van plan aan elk onderwerp te besteden?",
        "planner-main-strategy-2-task-1": "2.1 Lezen/Schrijven over energie selectie",
        "planner-main-strategy-2-task-2": "2.2 Lezen/Schrijven over voor- en nadelen",
        "planner-main-strategy-2-task-3": "2.3 Lezen/Schrijven over milieuimpact",
        "planner-main-strategy-3": "Uitvoerig schrijven, selectief lezen",
        "planner-main-strategy-3-instruction": "Hoeveel tijd ben je van plan te besteden aan de verschillende schrijf onderdelen?",
        "planner-main-strategy-3-task-1": "2.1 Plannen van de structuur van het essay",
        "planner-main-strategy-3-task-2": "2.2 Schrijven van de conceptversie",
        "planner-main-strategy-3-task-3": "2.3 Lezen over de aanvullende informatie die relevant is voor het essay",
        "planner-main-strategy-3-task-4": "2.4 Herzien en verbeteren van het essay",
        "planner-customise-plan-title": "Aanpassingsplan",
        "planner-select-main-strategy-hint": "Selecteer een strategie om door te gaan!",
        "planner-allocate-time-hint": "Wijs tijd toe aan alle taken! De totale tijd moet binnen de maximale tijd blijven!",
        ...
        "annotation-label-1": "Maak notitie",
        ...
        "gpt-scaffold-chat-send-btn-text": "Ctrl + Enter",
        "multi-agents-send-btn-text": "Ctrl+Enter",
        "annotation-toolbar-btn-hint": "Notitiepaneel",
        "annotation-search-toolbar-btn-hint": "Zoek notities tool",
        "gpt-scaffold-toolbar-btn-hint": "Instructietool",
        "essay-writing-toolbar-btn-hint": "Schrijftool",
        "planner-toolbar-btn-hint": "Planningstool",
        "multi-agents-single-window-toolbar-btn-hint": "Chatassistent",
        "timer-toolbar-btn-hint": "Tijdsklok",
        "like-response-text": "Vind je dit antwoord leuk?",
        "annotation-tool-data-label": "Notitietool",
        "search-annotation-tool-data-label": "Zoek annotatie tool (zoeken van aantekeningen)",
        "gpt-scaffold-tool-data-label": "Instructietool",
        "process-visual-tool-data-label": "",
        "essay-product-visual-tool-data-label": "",
        "collaborate-writing-tool-data-label": "",
        "essay-writing-tool-data-label": "Schrijftool",
        "math-tool-data-label": "",
        "planner-tool-data-label": "Planningstool",
        "checklist-tool-data-label": "",
        "multi-agents-single-window-tool-data-label": "Chatbot tool",
        "dictionary-tool-data-label": "",
        "timer-tool-data-label": "Tijdskloktool",
        "questionnaire-tool-data-label": "",
        "chat-reminder-message": "Deze chatbot is nu beschikbaar voor jou. Je kan de chatbot niet gebruiken om je essay te schrijven.",
        "multi-agents-single-window-placeholder-text-multi": "",
        "multi-agents-single-window-placeholder-text-single": "Schrijf hier iets om de chat te starten",
        "chat-reminder-message-title": "Herinneringsbericht",
        "scaffolding-message-title": "Feedback over je huidige voortgang:",
        "scaffold-chat-reminder": "Hoi, je bent al een tijdje bezig met chatten. Laten we teruggaan naar de hoofdtaak!",
    },
    pt: {
        "gpt-scaffold-prompt-template-groupA": "",
        "gpt-scaffold-prompt-template-groupB": `[[Início das Condições da Tarefa]]

Um estudante está trabalhando em uma redação.

Seguem as instruções da tarefa:

Tema da tarefa: Estratégia de Energia Renovável para uma Comunidade Costeira do Norte

Você foi contratado como especialista em energia para assessorar uma comunidade costeira do norte, situada perto de montanhas e que enfrenta invernos rigorosos e com muita neve. Essa comunidade depende fortemente da importação de combustíveis fósseis, que são caros, prejudiciais ao meio ambiente e pouco confiáveis ​​durante tempestades de inverno severas. A cidade busca uma solução que garanta um fornecimento de energia estável durante todo o ano, reduza os custos ao longo do tempo e, idealmente, crie empregos locais. A região recebe ventos marítimos constantes e está localizada perto de importantes recursos florestais manejados de forma sustentável. No entanto, a preservação da biodiversidade marinha local e dos ecossistemas florestais é uma prioridade para a comunidade.

Sua Tarefa:

Escreva uma breve proposta recomendando uma estratégia equilibrada de energia renovável, combinando dois tipos de energia renovável. Justifique claramente sua recomendação, discutindo:

Como cada fonte de energia renovável se adequa à geografia local, aos desafios climáticos e às demandas energéticas.
Viabilidade financeira e benefícios econômicos esperados, incluindo a geração de empregos.
Impactos ambientais potenciais e como sua estratégia mitiga os riscos para florestas e vida marinha.

Esta tarefa tem um limite de tempo de 45 minutos.

A seguir, a rubrica fornecida ao aluno:

Esta rubrica será usada para avaliar sua redação.

A redação deve ter entre 200 e 300 palavras.
Você NÃO deve copiar diretamente do texto ou de outras fontes – a redação deve ser escrita com suas próprias palavras.

A matriz a seguir é a rubrica de avaliação completa:

1. Indique as fontes de energia escolhidas:
    Excelente (3): Combina claramente dois tipos de energia e justifica a escolha de ambos.
    Bom (2): Menciona dois tipos de energia, mas com pouca explicação.
    Básico (1): Apenas um tipo de energia, ou solução pouco clara; pouca ou nenhuma explicação.

2. Uso de detalhes geográficos e climáticos:
    Excelente (3): Explica claramente como os dois tipos de energia se encaixam na geografia e no clima locais.
    Bom (2): Fornece alguns detalhes sobre a geografia/clima local, mas não os relaciona à escolha da energia.
    Básico (1): Pouco ou nenhum uso de detalhes locais; as opções energéticas não se adequam ao cenário.

3. Benefícios Econômicos e de Emprego:
    Excelente (3): Explicação clara de como o plano economiza dinheiro e cria empregos locais.
    Bom (2): Menciona dinheiro ou empregos, mas fornece poucos detalhes.
    Básico (1): Não menciona dinheiro ou empregos, ou fornece informações incorretas.

4. Proteção Ambiental:
    Excelente (3): Explica claramente como o plano protege florestas e áreas marinhas; apresenta maneiras específicas de evitar riscos.
    Bom (2): Menciona o impacto ambiental, mas fornece poucos detalhes sobre a proteção.
    Básico (1): Pouca ou nenhuma menção ao meio ambiente, ou ignora os riscos à natureza.

5. Qualidade da Escrita:
    Excelente (3): A escrita é clara, sem erros de gramática ou ortografia. As ideias fluem logicamente.
    Bom (2): Alguns erros de gramática ou ortografia tornam as ideias menos claras. O significado às vezes é obscuro.
    Básico (1): Erros frequentes de gramática ou ortografia; as ideias são difíceis de acompanhar ou não são coerentes.

[[Fim das condições da tarefa]]
...
[[Início da sua tarefa]]
    ...
    Para este feedback, siga a estrutura de feedback eficaz. Ela é centrada no aluno e deve incluir três componentes principais:

1. Com base nas condições de aprendizagem listadas acima, utilize os pontos fortes e as fraquezas do desempenho do aluno para orientar o ensino.
2. Concentre-se no impacto subsequente, fornecendo comentários com informações práticas para ajudar o aluno a atingir os objetivos de aprendizagem da tarefa. Isso deve ser baseado nas orientações listadas acima.
3. Ajude o aluno a sentir-se no controle de sua aprendizagem, atenda às suas necessidades sociais, emocionais e motivacionais e incentive-o a estar aberto a comentários avaliativos.

Observe as seguintes restrições:

Evite ao máximo dar instruções detalhadas sobre o que deve ser incluído na redação!

Certifique-se de incluir apenas o texto do feedback!

Por fim, o feedback NÃO DEVE exceder 100 palavras!

[[Fim da sua tarefa]]
`,
        "gpt-scaffold-prompt-template-groupC": `[[Início das Condições da Tarefa]]
...
[[Fim da sua tarefa]]
`,
        "gpt-scaffold-need-check-srl-prompt-CMTC1": `Até este ponto da sessão de aprendizagem, os estudantes que tiveram um bom desempenho nesta tarefa certificaram-se de estar cientes do limite de tempo para a tarefa, utilizando a ferramenta de cronômetro fornecida. Este não parece ser o caso deste aluno. Poderia, por favor, fornecer ao aluno um feedback em formato de parágrafo (não utilize marcadores ou listas numeradas) sobre como melhorar o monitoramento das restrições de tempo utilizando a ferramenta de cronômetro fornecida, cujo botão de tempo na barra de ferramentas possui um símbolo de relógio? Enquanto isso, considere cuidadosamente todas as seguintes condições de aprendizagem deste aluno:`,
        "gpt-scaffold-need-check-srl-prompt-CMTR": `Até este ponto da sessão de aprendizagem, os estudantes que tiveram um bom desempenho nesta tarefa certificaram-se de consultar os requisitos da tarefa e as informações da rubrica para avaliar o rascunho da redação e verificar se a escrita estava alinhada com os requisitos da tarefa e a rubrica. Este não parece ser o caso deste estudante. Você poderia, por favor, fornecer ao estudante um feedback em formato de parágrafo (não use marcadores e listas numeradas) sobre como usar as informações das instruções da tarefa e da rubrica para avaliar o rascunho da redação e verificar se a escrita está bem alinhada com os requisitos da tarefa e a rubrica, tentando ao máximo EVITAR dar instruções detalhadas sobre o que precisa ser incluído na redação? Enquanto isso, considere cuidadosamente todas as seguintes condições de aprendizagem deste estudante:`,
        ...
        "gpt-scaffold-need-check-srl-prompt-CSTR2": `Até este ponto da sessão de aprendizagem, os estudantes que tiveram um bom desempenho nesta tarefa certificaram-se de compreender claramente os requisitos da tarefa e a rubrica. Este não parece ser o caso deste aluno. Você poderia, por favor, fornecer ao aluno um feedback em formato de parágrafo (sem usar marcadores ou listas numeradas) sobre como melhorar a compreensão das instruções da tarefa e da rubrica, apoiando a autoconsciência do aluno em alinhar a redação da redação com os requisitos da tarefa e a rubrica, tentando ao máximo EVITAR dar instruções detalhadas sobre o que precisa ser incluído na redação? Enquanto isso, considere cuidadosamente todas as seguintes condições de aprendizagem deste aluno:`,
        "gpt-scaffold-need-check-srl-prompt-STR-MTC": `Até este ponto da sessão de aprendizagem, os estudantes que tiveram um bom desempenho nesta tarefa garantiram que estavam cientes do limite de tempo ou da tarefa usando a ferramenta de cronômetro fornecida e, ao mesmo tempo, compreenderam claramente os requisitos da tarefa e a rubrica. Este não parece ser o caso deste estudante. Você poderia, por favor, fornecer ao estudante um feedback em formato de parágrafo (sem usar marcadores e listas numeradas) que combine conselhos sobre todas essas áreas, sobre como melhorar o controle do tempo usando a ferramenta de cronômetro fornecida (o botão de tempo na barra de ferramentas tem o símbolo de um relógio) e sobre como melhorar a compreensão das instruções da tarefa e da rubrica, apoiando a autoconsciência do aluno em alinhar a redação com os requisitos da tarefa e a rubrica, tentando ao máximo EVITAR dar instruções detalhadas sobre o que precisa ser incluído na redação? Enquanto isso, considere cuidadosamente todas as seguintes condições de aprendizagem deste estudante:`,
        ...
        "gpt-scaffold-need-check-srl-prompt-OT2": `Até este ponto da sessão de aprendizagem, os estudantes que tiveram um bom desempenho nesta tarefa garantiram que explicassem as ideias com suas próprias palavras, com base no material de leitura. Este não parece ser o caso deste estudante. Você poderia, por favor, fornecer ao estudante um feedback em formato de parágrafo (sem usar marcadores e listas numeradas) sobre a importância de explicar as ideias com suas próprias palavras, demonstrando ao mesmo tempo a compreensão do material de leitura? Você deve estar ciente de que não pode fornecer instruções detalhadas sobre como o estudante deve escrever a redação. Enquanto isso, considere cuidadosamente todas as seguintes condições de aprendizagem deste estudante:`,
        "annotation-notes-title": "Painel de Anotações",
        "annotation-notes-delete-confirm-message": "Deseja excluir?",
        ...
        "essay-save-toast-text": "Sua redação foi salva!",
        ...
        "gpt-scaffold-user-take-pre-study-prompt": "Este estudante participou do estudo anterior, portanto, possui um certo nível de conhecimento da tarefa.",
        ...
        "gpt-scaffold-pretest-grades-prompt-0": "Este estudante tem um alto nível de conhecimento sobre energia renovável.",
        "gpt-scaffold-pretest-grades-prompt-5": "Este estudante tem um baixo nível de conhecimento sobre energia renovável.",
        "gpt-scaffold-pretest-grades-prompt-10": "Este estudante tem um nível médio de conhecimento sobre energia renovável.",
        ...
        "gpt-scaffold-mai-knowledge-cognition-prompt-33": "Este estudante tem alguma compreensão de maneiras de aprender com eficácia e pode citar algumas estratégias que ajudam.",
        ...
        "gpt-scaffold-mai-regulation-cognition-prompt-21": "Este estudante não planeja com antecedência nem acompanha seu aprendizado enquanto trabalha.",
        "gpt-scaffold-mai-regulation-cognition-prompt-33": "Este estudante presta alguma atenção ao planejamento e à verificação do seu aprendizado durante as tarefas.",
        "gpt-scaffold-test-mai-name": "Atividade 3: Refletindo sobre seu aprendizado",
        "gpt-scaffold-test-isdimu-name": "Atividade 3: conhecimento em táticas de aprendizagem",
        "gpt-scaffold-pretest-name": "Atividade 2: Quanto você sabe sobre energia renovável?",
        ...
        "gpt-scaffold-planner-select-prompt-2": "Este estudante elaborou o plano de [ler e escrever simultaneamente] para esta tarefa.",
        ...
        "gpt-scaffold-need-check-subaction-prompt-SAVE_PLANNER-not-exist": "Este estudante não elaborou planos explícitos sobre como realizará a tarefa.",
        "gpt-scaffold-need-check-subaction-prompt-SAVE_PLANNER-exist": "Este estudante elaborou planos explícitos sobre como realizará a tarefa.",
        "gpt-scaffold-need-check-subaction-prompt-TIMER-not-exist": "Este estudante não está ciente do tempo restante para concluir a tarefa.",
        "gpt-scaffold-need-check-subaction-prompt-TIMER-exist": "Este estudante está ciente do tempo restante para concluir a tarefa.",
        "gpt-scaffold-need-check-subaction-prompt-TRY_OUT_TOOLS-not-exist": "Este estudante não conhece as ferramentas disponíveis no ambiente que podem ajudá-lo a concluir a tarefa.",
        "gpt-scaffold-need-check-subaction-prompt-TRY_OUT_TOOLS-exist": "Este estudante conhece as ferramentas disponíveis no ambiente que podem ajudá-lo a concluir a tarefa.",
        "gpt-scaffold-need-check-subaction-prompt-PAGE_NAVIGATION-not-exist": "Este estudante não conhece os materiais de leitura disponíveis no ambiente que podem ajudá-lo com a tarefa.",
        "gpt-scaffold-need-check-subaction-prompt-PAGE_NAVIGATION-exist": "Este estudante conhece os materiais de leitura disponíveis no ambiente que podem ajudá-lo com a tarefa.",
        "gpt-scaffold-need-check-subaction-prompt-RUBRIC-not-exist": "Este estudante não conhece a rubrica.",
        "gpt-scaffold-need-check-subaction-prompt-RUBRIC-exist": "Este estudante conhece a rubrica.",
        "gpt-scaffold-need-check-subaction-prompt-TASK_REQUIREMENT-not-exist": "Este estudante não conhece as instruções da tarefa.",
        "gpt-scaffold-need-check-subaction-prompt-TASK_REQUIREMENT-exist": "Este estudante conhece as instruções da tarefa.",
        ...
        "planner-reading-strategy-1": "Leia o material página por página",
        "planner-reading-strategy-2": "Faça uma leitura rápida e depois uma leitura detalhada",
        "planner-reading-strategy-3": "Use a ferramenta de destaque para marcar o conteúdo principal",
        "planner-reading-strategy-4": "Anote seu entendimento enquanto lê",
        "planner-reading-strategy-5": "Leitura guiada por perguntas com foco em determinado conteúdo",
        "planner-reading-strategy-6": "Leia seletivamente e ignore o conteúdo irrelevante",
        "planner-reading-strategy-instruction": "Quais habilidades de leitura você planeja usar (múltipla escolha)?",
        "planner-writing-strategy-1": "Primeiro, rascunhar a estrutura da redação e depois preencher com os detalhes.",
        "planner-writing-strategy-2": "Usar minhas anotações e destaques ao escrever a redação.",
        "planner-writing-strategy-3": "Revisar as instruções e rubricas para alinhar a escrita.",
        "planner-writing-strategy-4": "Copiar e colar frases-chave e, em seguida, reescrevê-las com fluência.",
        "planner-writing-strategy-5": "Usar a estrutura e os padrões de escrita que aprendi.",
        ...
        "planner-main-strategy-1-instruction": "Quanto tempo você planeja dedicar à leitura e à escrita, respectivamente?",
        "planner-main-strategy-1-task-1": "2.1 Tempo que será dedicado à leitura",
        "planner-main-strategy-1-task-2": "2.2 Tempo que será dedicado à escrita",
        "planner-main-strategy-2": "Leia e escreva simultaneamente",
        "planner-main-strategy-2-instruction": "Quanto tempo você planeja dedicar a cada tópico?",
        "planner-main-strategy-2-task-1": "2.1 Leia/escreva sobre seleção de energia",
        "planner-main-strategy-2-task-2": "2.2 Leia/escreva sobre custos e benefícios",
        "planner-main-strategy-2-task-3": "2.3 Leia/escreva sobre impactos ambientais",
        "planner-main-strategy-3": "Escreva intensivamente, leia seletivamente",
        "planner-main-strategy-3-instruction": "Quanto tempo você planeja dedicar a cada etapa da escrita?",
        "planner-main-strategy-3-task-1": "2.1 Planeje a estrutura da redação:",
        "planner-main-strategy-3-task-2": "2.2 Escreva o primeiro rascunho:",
        "planner-main-strategy-3-task-3": "2.3 Leia informações adicionais relevantes para a redação:",
        "planner-main-strategy-3-task-4": "2.4 Revise e aprimore a redação:",
        "planner-customise-plan-title": "Plano de personalização",
        ...
        "gpt-scaffold-chat-send-btn-text": "Ctrl + Enter",
        "multi-agents-send-btn-text": "Ctrl+Enter",
        "annotation-toolbar-btn-hint": "Painel de Anotações",
        "annotation-search-toolbar-btn-hint": "Ferramenta de busca de anotações",
        "gpt-scaffold-toolbar-btn-hint": "Ferramenta de Instruções",
        ...
        "like-response-text": "Gostou desta resposta?",
        "annotation-tool-data-label": "Ferramenta de Anotações",
        "search-annotation-tool-data-label": "Ferramenta de pesquisa de anotações",
        "gpt-scaffold-tool-data-label": "Ferramenta de Instruções",
        "process-visual-tool-data-label": "",
        "essay-product-visual-tool-data-label": "",
        "collaborate-writing-tool-data-label": "",
        "essay-writing-tool-data-label": "Ferramenta de escrita",
        "math-tool-data-label": "",
        "planner-tool-data-label": "Ferramenta de planejamento",
        "checklist-tool-data-label": "",
        "multi-agents-single-window-tool-data-label": "Ferramenta de chatbot",
        "dictionary-tool-data-label": "",
        "timer-tool-data-label": "Ferramenta de temporizador",
        "questionnaire-tool-data-label": "",
        "chat-reminder-message": "Este chatbot agora está disponível para você. Você não pode usar o chatbot para escrever sua redação.",
        "multi-agents-single-window-placeholder-text-multi": "",
        "multi-agents-single-window-placeholder-text-single": "Digite o texto para iniciar o chat",
        "chat-reminder-message-title": "Mensagem de lembrete",
...
[[KONIEC TVOJEJ ÚLOHY]]`,
        ...
        "gpt-scaffold-test-mai-name": "Aktivita 3: Zamyslenie sa o tvojom učení",
        "gpt-scaffold-test-isdimu-name": "Aktivita 3: ISDIMU",
        "gpt-scaffold-pretest-name": "Aktivita 2: Koľko toho vieš o obnoviteľnej energii?",
        "gpt-scaffold-check-take-previous-study-name": "Aktivita 1: O sebe",
...
หลักเกณฑ์ต่อไปนี้ใช้สำหรับประเมินเรียงความของคุณ
 เรียงความควรมีจำนวน 1000 - 1600 ตัวอักษร
 ห้ามคัดลอกเนื้อหาโดยตรง จากบทอ่านหรือแหล่งข้อมูลอื่น — เรียงความต้องเขียนด้วย ถ้อยคำของคุณเอง
 ตารางด้านล่างนี้คือ เกณฑ์การให้คะแนนฉบับสมบูรณ์

1. การระบุแหล่งพลังงานที่เลือก(Indicate the chosen energy sources)
ระดับดีเยี่ยม (Excellent – 3 คะแนน): ระบุแหล่งพลังงานหมุนเวียนสองประเภทอย่างชัดเจน พร้อมให้เหตุผลประกอบที่เหมาะสมสำหรับแต่ละประเภท
ระดับดี (Good – 2 คะแนน): ระบุพลังงานสองประเภท แต่ให้คำอธิบายน้อยหรือไม่ชัดเจน
ระดับพื้นฐาน (Basic – 1 คะแนน): ระบุเพียงแหล่งเดียว หรือแนวทางไม่ชัดเจน และไม่มีคำอธิบายสนับสนุน
2. การใช้ข้อมูลด้านภูมิศาสตร์และภูมิอากาศ(Use of Geographic & Climate Details)
ระดับดีเยี่ยม (Excellent – 3 คะแนน): อธิบายได้ชัดเจนว่าทั้งสองแหล่งพลังงานเหมาะกับภูมิประเทศและภูมิอากาศของพื้นที่อย่างไร
ระดับดี (Good – 2 คะแนน): มีการกล่าวถึงภูมิศาสตร์หรือภูมิอากาศบ้าง แต่ไม่เชื่อมโยงกับการเลือกพลังงานอย่างชัดเจน
ระดับพื้นฐาน (Basic – 1 คะแนน): แทบไม่กล่าวถึงรายละเอียดของพื้นที่ หรือการเลือกพลังงานไม่สอดคล้องกับบริบทของชุมชน
3. ผลประโยชน์ทางเศรษฐกิจและการจ้างงาน(Economic and Job Benefits)
ระดับดีเยี่ยม (Excellent – 3 คะแนน): อธิบายอย่างชัดเจนว่าแผนสามารถช่วยประหยัดค่าใช้จ่ายและสร้างงานในท้องถิ่นได้อย่างไร
ระดับดี (Good – 2 คะแนน): กล่าวถึงเรื่องเศรษฐกิจหรือการจ้างงานบางส่วน แต่ให้รายละเอียดน้อย
ระดับพื้นฐาน (Basic – 1 คะแนน): ไม่กล่าวถึง หรือให้ข้อมูลผิดเกี่ยวกับต้นทุนและผลประโยชน์ทางเศรษฐกิจ
4. การปกป้องสิ่งแวดล้อม(Environmental Protection)
ระดับดีเยี่ยม (Excellent – 3 คะแนน): อธิบายชัดเจนว่าแผนของคุณช่วยปกป้องป่าไม้และสิ่งมีชีวิตทางทะเลได้อย่างไร พร้อมยกตัวอย่างแนวทางลดความเสี่ยง
ระดับดี (Good – 2 คะแนน): กล่าวถึงผลกระทบต่อสิ่งแวดล้อมบางส่วน แต่ไม่ได้อธิบายวิธีป้องกันอย่างชัดเจน
ระดับพื้นฐาน (Basic – 1 คะแนน): แทบไม่กล่าวถึงสิ่งแวดล้อม หรือเพิกเฉยต่อความเสี่ยงที่อาจเกิดขึ้นกับธรรมชาติ
5. คุณภาพการเขียน(Writing Quality)
ระดับดีเยี่ยม (Excellent – 3 คะแนน): การเขียนชัดเจน ไม่มีข้อผิดพลาดทางไวยากรณ์หรือการสะกดคำ ความคิดเรียงลำดับอย่างเป็นระบบและเข้าใจง่าย
ระดับดี (Good – 2 คะแนน): มีข้อผิดพลาดทางไวยากรณ์หรือการสะกดคำเล็กน้อย ทำให้ความหมายบางส่วนไม่ชัด
ระดับพื้นฐาน (Basic – 1 คะแนน): มีข้อผิดพลาดบ่อย ทำให้ข้อความเข้าใจยาก และแนวคิดไม่เป็นระบบ
...
`,
        ...
        "gpt-scaffold-test-mai-name": "กิจกรรมที่ 3: การสะท้อนผลการเรียนรู้ของคุณ",
        "gpt-scaffold-test-isdimu-name": "กิจกรรม 3: ISDIMU",
        "gpt-scaffold-pretest-name": "กิจกรรมที่ 2: คุณรู้จักพลังงานหมุนเวียนมากแค่ไหน",
...
[[你的任务结束]]`,
        ...
        "gpt-scaffold-need-check-subaction-prompt-RUBRIC-not-exist": "这名学生不知道有评分标准。",
        "gpt-scaffold-need-check-subaction-prompt-RUBRIC-exist": "这名学生知道有评分标准。",
        "gpt-scaffold-need-check-subaction-prompt-TASK_REQUIREMENT-not-exist": "这名学生不知道有任务说明。",
        "gpt-scaffold-need-check-subaction-prompt-TASK_REQUIREMENT-exist": "这名学生知道有任务说明。",
...
[[任務結束]]`,
        ...
        "annotation-search-toolbar-btn-hint": "注解搜索",
        "gpt-scaffold-toolbar-btn-hint": "",
        "essay-writing-toolbar-btn-hint": "",
        "planner-toolbar-btn-hint": "",
        "multi-agents-single-window-toolbar-btn-hint": "聊天助理",
        ...
        "annotation-tool-data-label": "注釋工具",
        "search-annotation-tool-data-label": "搜索注釋工具",
        "gpt-scaffold-tool-data-label": "指令工具",
        "process-visual-tool-data-label": "",
        "essay-product-visual-tool-data-label": "",
        "collaborate-writing-tool-data-label": "",
        "essay-writing-tool-data-label": "寫作工具",
        "math-tool-data-label": "",
        "planner-tool-data-label": "計劃工具",
        "checklist-tool-data-label": "",
        "multi-agents-single-window-tool-data-label": "聊天機器人工具",
        "dictionary-tool-data-label": "",
        "timer-tool-data-label": "計時器工具",
        "questionnaire-tool-data-label": "",
...
2.4 審閱並改進文章：`,
    ...
    vi: {
        "gpt-scaffold-prompt-template-groupA": "",
        "gpt-scaffold-prompt-template-groupB": `→ [[Bắt đầu điều kiện nhiệm vụ]]
→ Một học sinh đang thực hiện nhiệm vụ viết bài luận.
→ Dưới đây là yêu cầu của nhiệm vụ:
→ Chủ đề: Chiến lược năng lượng tái tạo cho một cộng đồng ven biển phía Bắc
→ Bạn được thuê với vai trò chuyên gia năng lượng để tư vấn cho một cộng đồng ven biển phía Bắc, nằm gần khu vực núi và phải đối mặt với mùa đông khắc nghiệt, nhiều tuyết. Cộng đồng này hiện phụ thuộc nhiều vào nhiên liệu hóa thạch nhập khẩu, vốn có chi phí cao, gây hại cho môi trường và không đáng tin cậy trong các đợt bão mùa đông nghiêm trọng. Thị trấn đang tìm kiếm một giải pháp có thể đảm bảo nguồn cung năng lượng ổn định quanh năm, giảm chi phí theo thời gian và lý tưởng là tạo ra việc làm tại địa phương. Khu vực này có gió biển ngoài khơi ổn định và nằm gần nguồn tài nguyên rừng đáng kể được quản lý bền vững. Tuy nhiên, việc bảo tồn đa dạng sinh học biển và hệ sinh thái rừng tại địa phương là ưu tiên hàng đầu của cộng đồng.
Nhiệm vụ của bạn:
→ Hãy viết một bản đề xuất ngắn, đưa ra một chiến lược năng lượng tái tạo cân bằng kết hợp hai loại năng lượng tái tạo. Hãy giải thích rõ ràng đề xuất của bạn bằng cách trình bày:
→ Cách mỗi nguồn năng lượng phù hợp với điều kiện địa lý địa phương, các thách thức khí hậu và nhu cầu năng lượng.
→ Tính khả thi về tài chính và các lợi ích kinh tế dự kiến, bao gồm việc tạo việc làm.
→ Các tác động môi trường tiềm ẩn và cách chiến lược của bạn giảm thiểu rủi ro đối với rừng và hệ sinh thái biển.
→ Thời gian thực hiện nhiệm vụ này là 45 phút.
→ Dưới đây là bảng tiêu chí chấm điểm được cung cấp cho học sinh:
→ Bảng tiêu chí này được sử dụng để đánh giá bài luận của bạn.
→ Bài luận gồm từ 200 đến 300 từ.
→ Bạn KHÔNG được sao chép trực tiếp từ tài liệu đã đọc hoặc từ các nguồn khác — bài luận phải được viết bằng chính lời của bạn.

→ Bảng dưới đây là tiêu chí chấm điểm đầy đủ:
→ 1. Xác định các nguồn năng lượng được lựa chọn:
→ Xuất sắc (3): Kết hợp rõ ràng hai loại năng lượng và đưa ra lý do cho cả hai.
→ Tốt (2): Đề cập đến hai loại năng lượng nhưng giải thích còn hạn chế.
→ Cơ bản (1): Chỉ một loại năng lượng hoặc giải pháp không rõ ràng; giải thích rất ít hoặc không có.


→ 2. Sử dụng thông tin về địa lý và khí hậu:
→ Xuất sắc (3): Giải thích rõ ràng cách cả hai nguồn năng lượng phù hợp với địa lý và khí hậu địa phương.
→ Tốt (2): Đưa ra một số thông tin nhưng chưa liên kết với lựa chọn năng lượng.
→ Cơ bản (1): Ít hoặc không sử dụng thông tin địa phương; lựa chọn không phù hợp.

→ 3. Lợi ích kinh tế và việc làm:
→ Xuất sắc (3): Giải thích thuyết phục cách kế hoạch tiết kiệm chi phí và tạo việc làm.
→ Tốt (2): Có đề cập nhưng thiếu chi tiết.
→ Cơ bản (1): Không đề cập hoặc thông tin sai.

→ 4. Bảo vệ môi trường:
→ Xuất sắc (3): Giải thích rõ cách bảo vệ rừng và hệ sinh thái biển; đưa ra biện pháp cụ thể.
→ Tốt (2): Có đề cập nhưng thiếu chi tiết.
→ Cơ bản (1): Ít hoặc không đề cập, hoặc bỏ qua rủi ro.

→ 5. Chất lượng bài viết:
→ Xuất sắc (3): Bài viết rõ ràng, không lỗi ngữ pháp/chính tả, mạch lạc.
→ Tốt (2): Có lỗi nhỏ, đôi khi làm giảm độ rõ ràng.
→ Cơ bản (1): Nhiều lỗi, khó hiểu, thiếu mạch lạc.

→ [[Kết thúc điều kiện nhiệm vụ]]
    ;;;SRL_PROCESS_PROMPT;;;

    Please note the following learning conditions of this student:
    ;;;ADAPTIVE_PROMPT;;;
    
    Đối với phần phản hồi này, vui lòng tuân theo khung phản hồi hiệu quả. Khung này lấy người học làm trung tâm và cần bao gồm ba thành phần chính:

Dựa trên các điều kiện học tập đã nêu ở trên, sử dụng cả điểm mạnh và điểm yếu trong quá trình thực hiện của học sinh để định hướng phản hồi.
Tập trung vào tác động tiếp theo bằng cách đưa ra nhận xét có tính hành động nhằm giúp học sinh đạt được mục tiêu học tập của nhiệm vụ. Nội dung này nên dựa trên các lời khuyên đã nêu ở trên.
Hỗ trợ học sinh cảm thấy làm chủ việc học của mình, quan tâm đến nhu cầu xã hội, cảm xúc và động lực, đồng thời khuyến khích các em cởi mở với các nhận xét đánh giá.

Lưu ý các yêu cầu sau:

Hãy cố gắng TRÁNH đưa ra BẤT KỲ hướng dẫn chi tiết nào về những gì cần có trong bài luận!

Vui lòng đảm bảo bạn chỉ xuất ra nội dung phản hồi!

Cuối cùng, phản hồi KHÔNG được vượt quá 100 từ!

[[Kết thúc nhiệm vụ của bạn]]`,
        "gpt-scaffold-prompt-template-groupC": `→ [[Bắt đầu điều kiện nhiệm vụ]]
→ Một học sinh đang thực hiện nhiệm vụ viết bài luận.
→ Dưới đây là yêu cầu của nhiệm vụ:
→ Chủ đề: Chiến lược năng lượng tái tạo cho một cộng đồng ven biển phía Bắc
→ Bạn được thuê với vai trò chuyên gia năng lượng để tư vấn cho một cộng đồng ven biển phía Bắc, nằm gần khu vực núi và phải đối mặt với mùa đông khắc nghiệt, nhiều tuyết. Cộng đồng này hiện phụ thuộc nhiều vào nhiên liệu hóa thạch nhập khẩu, vốn có chi phí cao, gây hại cho môi trường và không đáng tin cậy trong các đợt bão mùa đông nghiêm trọng. Thị trấn đang tìm kiếm một giải pháp có thể đảm bảo nguồn cung năng lượng ổn định quanh năm, giảm chi phí theo thời gian và lý tưởng là tạo ra việc làm tại địa phương. Khu vực này có gió biển ngoài khơi ổn định và nằm gần nguồn tài nguyên rừng đáng kể được quản lý bền vững. Tuy nhiên, việc bảo tồn đa dạng sinh học biển và hệ sinh thái rừng tại địa phương là ưu tiên hàng đầu của cộng đồng.
...
[[Kết thúc nhiệm vụ của bạn]]`,
        "gpt-scaffold-need-check-srl-prompt-CMTC1": `Bạn đang có xu hướng tập trung vào nội dung bài làm mà chưa thực sự chú ý đến yếu tố thời gian, trong khi đây là một nhiệm vụ bị giới hạn trong 45 phút. Để cải thiện điều này, bạn nên chủ động sử dụng công cụ hẹn giờ có biểu tượng hình đồng hồ trên thanh công cụ ngay từ khi bắt đầu làm bài. Việc này không chỉ giúp bạn nhận thức rõ lượng thời gian còn lại mà còn hỗ trợ bạn phân bổ thời gian hợp lý cho từng phần của bài viết, ví dụ như dành thời gian cho việc lập ý, viết nháp và kiểm tra lại. Khi có đồng hồ đếm ngược, bạn sẽ dễ dàng điều chỉnh tốc độ làm bài nếu nhận ra mình đang dành quá nhiều thời gian cho một phần nào đó. Ngoài ra, việc thường xuyên nhìn lại thời gian còn lại cũng giúp bạn tránh tình trạng viết dở dang hoặc không kịp hoàn thiện bài. Nói cách khác, sử dụng công cụ hẹn giờ không chỉ là để theo dõi thời gian, mà còn là một chiến lược giúp bạn kiểm soát quá trình làm bài hiệu quả hơn và đảm bảo hoàn thành nhiệm vụ đúng hạn.`,
        "gpt-scaffold-need-check-srl-prompt-CMTR": `Có vẻ như bạn chưa thực sự sử dụng yêu cầu đề bài và bảng tiêu chí như một công cụ để tự kiểm tra và điều chỉnh bài viết của mình trong quá trình làm bài. Điều này khiến bạn khó nhận ra liệu bài viết đã đi đúng hướng hay chưa. Để cải thiện, bạn nên xem lại yêu cầu và rubric không chỉ ở đầu mà còn trong suốt quá trình viết, như một “bản định hướng” giúp bạn theo dõi tiến độ và chất lượng bài làm. Khi viết xong một phần hoặc toàn bộ bài, bạn có thể tự đặt câu hỏi xem nội dung mình vừa viết có thực sự phù hợp với những tiêu chí đánh giá hay không, và liệu có điểm nào chưa rõ ràng hoặc chưa được thể hiện đầy đủ. Việc chủ động đối chiếu như vậy sẽ giúp bạn phát hiện sớm những chỗ chưa phù hợp và điều chỉnh kịp thời, thay vì chỉ nhận ra sau khi đã hoàn thành bài. Dần dần, thói quen này sẽ giúp bạn nâng cao khả năng tự đánh giá và đảm bảo bài viết luôn bám sát yêu cầu cũng như đạt chất lượng tốt hơn.
`,
        "gpt-scaffold-need-check-srl-prompt-CMTR2": "",
        "gpt-scaffold-need-check-srl-prompt-CSTR2": `Có thể thấy bạn chưa thực sự dành đủ thời gian để hiểu sâu yêu cầu của đề bài và các tiêu chí chấm điểm, điều này dễ khiến bài viết bị lệch hướng so với kỳ vọng. Để cải thiện, bạn nên hình thành thói quen đọc lại đề và rubric một cách chủ động trước khi bắt đầu viết, không chỉ đọc lướt mà cần tự kiểm tra xem mình đã hiểu đúng chưa. Một cách hiệu quả là tự diễn giải lại yêu cầu bằng lời của chính mình và tự hỏi bài viết của mình sẽ được đánh giá dựa trên những khía cạnh nào. Khi đang viết, bạn cũng nên thỉnh thoảng dừng lại để đối chiếu xem nội dung mình đang phát triển có thực sự phù hợp với những tiêu chí đó hay không. Việc này giúp bạn điều chỉnh kịp thời thay vì chỉ nhận ra sai lệch khi đã hoàn thành bài. Ngoài ra, sau khi viết xong, bạn có thể tự đánh giá bài của mình dựa trên rubric để xem mức độ đáp ứng đến đâu. Quá trình này sẽ giúp bạn nâng cao nhận thức về cách bài viết của mình liên kết với yêu cầu và tiêu chí chấm điểm, từ đó cải thiện chất lượng bài làm một cách nhất quán hơn.
`,
        "gpt-scaffold-need-check-srl-prompt-STR-MTC": `Bạn dường như chưa tận dụng tốt hai yếu tố rất quan trọng của nhiệm vụ này là quản lý thời gian và hiểu rõ yêu cầu cũng như tiêu chí chấm điểm, điều này có thể khiến bài làm chưa đạt được hiệu quả tối đa. Để cải thiện, trước hết bạn nên chủ động sử dụng công cụ hẹn giờ với biểu tượng hình đồng hồ ngay khi bắt đầu, nhằm giúp bạn luôn ý thức được mình đang ở giai đoạn nào trong khoảng thời gian giới hạn. Việc thường xuyên theo dõi thời gian sẽ giúp bạn điều chỉnh tốc độ làm bài và tránh tình trạng dành quá nhiều thời gian cho một phần mà bỏ sót các phần khác. Song song với đó, bạn cần dành thời gian đọc kỹ yêu cầu và rubric trước khi viết, không chỉ để hiểu mà còn để tự hình dung cách bài viết của mình sẽ được đánh giá. Trong quá trình làm bài, hãy tập thói quen dừng lại và tự hỏi liệu những gì mình đang viết có thực sự phù hợp với yêu cầu và tiêu chí hay không. Sự kết hợp giữa việc theo dõi thời gian và liên tục đối chiếu với rubric sẽ giúp bạn kiểm soát tốt hơn toàn bộ quá trình làm bài, từ đó nâng cao chất lượng bài viết một cách rõ rệt.
`,
        "gpt-scaffold-need-check-srl-prompt-OR2": "",
        "gpt-scaffold-need-check-srl-prompt-OT2": `Có thể thấy bạn đang phụ thuộc khá nhiều vào cách diễn đạt của tài liệu đã học thay vì thực sự diễn giải lại ý tưởng theo cách hiểu của riêng mình, điều này làm giảm khả năng thể hiện mức độ hiểu sâu của bạn. Việc sử dụng ngôn từ của chính bạn không chỉ giúp bài viết trở nên tự nhiên hơn mà còn cho thấy bạn đã xử lý và nắm bắt được nội dung, thay vì chỉ ghi nhớ hoặc sao chép. Khi bạn tự diễn đạt, bạn buộc phải suy nghĩ lại ý nghĩa của thông tin, từ đó hiểu rõ hơn mối liên hệ giữa các ý tưởng và cách chúng phù hợp với nhiệm vụ. Điều này cũng giúp bạn linh hoạt hơn trong việc điều chỉnh nội dung sao cho phù hợp với yêu cầu và tiêu chí chấm điểm. Ngoài ra, việc viết bằng lời của mình còn giúp tránh các vấn đề liên quan đến sao chép và nâng cao chất lượng học thuật của bài làm. Nếu bạn tập trung vào việc thực sự hiểu nội dung trước, rồi sau đó diễn đạt lại một cách rõ ràng theo cách của mình, bài viết của bạn sẽ thể hiện được cả kiến thức lẫn khả năng tư duy một cách thuyết phục hơn.
`,
        "annotation-notes-title": "Bảng ghi chú",
        "annotation-notes-delete-confirm-message": "Bạn có muốn xóa không?",
        "annotation-write-note-placeholder": "Vieết ghi chú tại đây",
        "annotation-tag-placeholder": "Nhập thẻ mới và nhấn Enter",
        "annotation-note-save-btn-text": "Lưu",
        "annotation-note-cancel-btn-text": "Hủy",
        "annotation-search-btn-text": "Tiìm kiếm",
        "annotation-search-panel-input-placeholder": "Nhập từ khóa để tìm kiếm",
        "scaffolding-title": "Bảng hướng dẫn",
        "scaffolding-create-checklist-btn-text": "",
        "scaffolding-edit-checklist-btn-text": "",
        "scaffolding-unread-message-text": "Tin nhắn chưa đọc",
        "scaffolding-chat-open-text": "Mở trò chuyện",
        "gpt-scaffolding-title": "Bảng hướng dẫn",
        "planner-title": "Công cụ lập kế hoạch",
        "planner-learning-strategy-select-label-text": "Vui lòng xây dựng kế hoạch cho chiến lược học tập của bạn:",
        "planner-learning-strategy-select-option1-text": "Chọn một chiến lược",
        "planner-learning-strategy-select-customise-option-text": "Sử dụng chiến lược của riêng bạn",
        "planner-add-more-customise-strategy-btn-text": "Thêm chiến lược",
        "planner-customise-option-hint-textarea-placeholder": "Vui lòng giải thích vì sao bạn thiết kế kế hoạch này?",
        "planner-next-btn-text": "Tiếp theo",
        "planner-time-unit-minute": "phút",
        "planner-display-plan-title": "Kế hoạch học tập của tôi",
        "planner-display-overall-strategy-label": "Chiến lược tổng thể:",
        "planner-display-time-allocation-label": "Phân bổ thời gian:",
        "planner-display-writing-strategy-label": "Chiến lược viết:",
        "planner-display-reading-strategy-label": "Chiến lược đọc:",
        "planner-customise-plan-reason-placeholder": "(Tùy chọn)",
        "essay-title": "→ Công cụ viết bài luận",
        "essay-save-btn-text": "Lưu bài luận",
        "essay-writing-placeholder": "→ Viết bài luận tại đây...",
        "essay-show-word-count-btn-text": "→ Số lượng từ",
        "essay-save-toast-text": "→ Bài luận của bạn đã được lưu!",
        "dictionary-title": "",
        "dictionary-send-btn-text": "",
        "dictionary-panel-input-placeholder": "",
        "checklist-title": "",
        ...
        "chatteacher-send-btn-text": "",
        "chatgpt-role-description": "",
        "gpt-scaffold-user-take-pre-study-prompt": "Học sinh này đã tham gia nghiên cứu trước đó nên đã có một mức độ hiểu biết nhất định về nhiệm vụ.",
        "gpt-scaffold-isdimu-prompt-0": "",
        "gpt-scaffold-isdimu-prompt-16": "",
        "gpt-scaffold-isdimu-prompt-32": "",
        "gpt-scaffold-pretest-grades-prompt-0": "Học sinh này có mức độ hiểu biết cao về năng lượng tái tạo.",
        "gpt-scaffold-pretest-grades-prompt-5": "Học sinh này có mức độ hiểu biết thấp về năng lượng tái tạo.",
        "gpt-scaffold-pretest-grades-prompt-10": "Học sinh này có mức độ hiểu biết trung bình về năng lượng tái tạo.",
        "gpt-scaffold-mai-knowledge-cognition-prompt-0": "Học sinh này hiểu rõ cách mình học tốt nhất và có thể lựa chọn các chiến lược học tập phù hợp.",
        "gpt-scaffold-mai-knowledge-cognition-prompt-21": "Học sinh này chưa rõ điều gì giúp mình học tốt hoặc chiến lược nào phù hợp nhất với bản thân.",
        "gpt-scaffold-mai-knowledge-cognition-prompt-33": "Học sinh này có một số hiểu biết về cách học hiệu quả và có thể nêu ra một vài chiến lược hữu ích.",
        "gpt-scaffold-mai-regulation-cognition-prompt-0": "Học sinh này lập kế hoạch, theo dõi và điều chỉnh việc học để đạt kết quả tốt hơn.",
        "gpt-scaffold-mai-regulation-cognition-prompt-21": "Học sinh này không lập kế hoạch trước hoặc theo dõi quá trình học khi đang thực hiện nhiệm vụ.",
        "gpt-scaffold-mai-regulation-cognition-prompt-33": "Học sinh này có chú ý ở mức độ nhất định đến việc lập kế hoạch và kiểm tra quá trình học trong khi làm nhiệm vụ.",
        "gpt-scaffold-test-mai-name": "Hoạt động 3: Suy ngẫm về việc học của bạn",
        "gpt-scaffold-test-isdimu-name": "",
        "gpt-scaffold-pretest-name": "Hoạt động 2: Bạn biết bao nhiêu về năng lượng tái tạo?",
        "gpt-scaffold-check-take-previous-study-name": "Hoạt động 1: Về bản thân bạn",
        "gpt-scaffold-planner-select-prompt-1": "Học sinh này đã đưa ra kế hoạch [đọc trước rồi viết] cho nhiệm vụ này.",
        "gpt-scaffold-planner-select-prompt-2": "Học sinh này đã đưa ra kế hoạch [đọc và viết đồng thời] cho nhiệm vụ này.",
        "gpt-scaffold-planner-select-prompt-3": "Học sinh này đã đưa ra kế hoạch [viết tập trung và đọc chọn lọc] cho nhiệm vụ này.",
        "gpt-scaffold-planner-select-prompt-4": "",
        "gpt-scaffold-need-check-subaction-prompt-SAVE_PLANNER-not-exist": "Học sinh này chưa xây dựng kế hoạch cụ thể cho cách thực hiện nhiệm vụ.",
        "gpt-scaffold-need-check-subaction-prompt-SAVE_PLANNER-exist": "Học sinh này đã xây dựng kế hoạch cụ thể cho cách thực hiện nhiệm vụ.",
        "gpt-scaffold-need-check-subaction-prompt-TIMER-not-exist": "Học sinh này không nhận thức được thời gian còn lại để hoàn thành nhiệm vụ.",
        "gpt-scaffold-need-check-subaction-prompt-TIMER-exist": "Học sinh này nhận thức được thời gian còn lại để hoàn thành nhiệm vụ.",
        "gpt-scaffold-need-check-subaction-prompt-TRY_OUT_TOOLS-not-exist": "Học sinh này không nhận thức được các công cụ có sẵn trong môi trường có thể giúp hoàn thành nhiệm vụ.",
        "gpt-scaffold-need-check-subaction-prompt-TRY_OUT_TOOLS-exist": "Học sinh này nhận thức được các công cụ có sẵn trong môi trường có thể giúp hoàn thành nhiệm vụ.",
        "gpt-scaffold-need-check-subaction-prompt-PAGE_NAVIGATION-not-exist": "Học sinh này không nhận thức được các tài liệu đọc có sẵn trong môi trường có thể hỗ trợ nhiệm vụ.",
        "gpt-scaffold-need-check-subaction-prompt-PAGE_NAVIGATION-exist": "Học sinh này nhận thức được các tài liệu đọc có sẵn trong môi trường có thể hỗ trợ nhiệm vụ.",
        "gpt-scaffold-need-check-subaction-prompt-RUBRIC-not-exist": "Học sinh này không nhận thức được rubric.",
        "gpt-scaffold-need-check-subaction-prompt-RUBRIC-exist": "Học sinh này nhận thức được rubric.",
        "gpt-scaffold-need-check-subaction-prompt-TASK_REQUIREMENT-not-exist": "Học sinh này không nhận thức được yêu cầu nhiệm vụ.",
        "gpt-scaffold-need-check-subaction-prompt-TASK_REQUIREMENT-exist": "Học sinh này nhận thức được yêu cầu nhiệm vụ.",
        "gpt-scaffold-role-description": "",
        "planner-customise-step2-instruction": "Vui lòng mô tả chi tiết chiến lược học tập mà bạn dự định áp dụng và cách bạn sẽ phân bổ thời gian. Bạn cũng có thể nêu lý do cho việc lựa chọn chiến lược và cách phân bổ thời gian đó.",
        "planner-reading-strategy-1": "Đọc tài liệu theo từng trang",
        "planner-reading-strategy-2": "Đọc lướt nhanh sau đó đọc chi tiết",
        "planner-reading-strategy-3": "Sử dụng công cụ đánh dấu để làm nổi bật nội dung quan trọng",
        "planner-reading-strategy-4": "Ghi lại những gì tôi hiểu vào ghi chú trong khi đọc",
        "planner-reading-strategy-5": "Đọc theo định hướng câu hỏi, tập trung vào nội dung cụ thể",
        "planner-reading-strategy-6": "Đọc có chọn lọc và bỏ qua nội dung không liên quan",
        "planner-reading-strategy-instruction": "Bạn dự định sử dụng những kỹ năng đọc nào (có thể chọn nhiều)?",
        "planner-writing-strategy-1": "Lập trước cấu trúc bài luận rồi sau đó bổ sung chi tiết",
        "planner-writing-strategy-2": "Sử dụng ghi chú và phần đã đánh dấu khi viết bài luận",
        "planner-writing-strategy-3": "Xem lại yêu cầu và rubric để điều chỉnh bài viết phù hợp",
        "planner-writing-strategy-4": "Sao chép các câu quan trọng rồi viết lại một cách trôi chảy",
        "planner-writing-strategy-5": "Sử dụng khung và mẫu viết đã học để viết",
        "planner-writing-strategy-instruction": "Bạn dự định sử dụng những kỹ năng viết nào (có thể chọn nhiều)?",
        "planner-main-strategy-1": "Đọc trước rồi viết",
        "planner-main-strategy-1-instruction": "Bạn dự định dành bao nhiêu thời gian cho việc đọc và viết tương ứng?",
        "planner-main-strategy-1-task-1": "2.1 Thời gian dành cho việc đọc",
        "planner-main-strategy-1-task-2": "2.2 Thời gian dành cho việc viết",
        "planner-main-strategy-2": "Đọc và viết đồng thời",
        "planner-main-strategy-2-instruction": "Bạn dự định dành bao nhiêu thời gian cho từng nội dung?",
        "planner-main-strategy-2-task-1": "2.1 Đọc/viết về việc lựa chọn năng lượng",
        "planner-main-strategy-2-task-2": "2.2 Đọc/viết về chi phí và lợi ích",
        "planner-main-strategy-2-task-3": "2.3 Đọc/viết về tác động môi trường",
        "planner-main-strategy-3": "Viết tập trung, đọc chọn lọc",
        "planner-main-strategy-3-instruction": "Bạn dự định dành bao nhiêu thời gian cho các giai đoạn khác nhau của quá trình viết?",
        "planner-main-strategy-3-task-1": "2.1 Lập kế hoạch cấu trúc bài luận:",
        "planner-main-strategy-3-task-2": "2.2 Viết bản nháp đầu tiên:",
        "planner-main-strategy-3-task-3": "2.3 Đọc thêm thông tin liên quan đến bài luận:",
        "planner-main-strategy-3-task-4": "2.4 Xem lại và cải thiện bài luận:",
        "planner-customise-plan-title": "Kế hoạch tùy chỉnh",
        "planner-select-main-strategy-hint": "Vui lòng chọn một chiến lược để tiếp tục!!!",
        "planner-allocate-time-hint": "Vui lòng phân bổ thời gian cho tất cả các nhiệm vụ và tổng thời gian phải nằm trong giới hạn yêu cầu!!!",
        "planner-select-reading-writing-strategy-hint": "Vui lòng chọn các kỹ năng bạn dự định sử dụng!!!",
        "planner-save-plan-hint": "Vui lòng điền đầy đủ tên chiến lược và thời gian chính xác!!!",
        "rule-based-scaffold-title-1": "",
        "rule-based-scaffold-title-1-task-1": "",
        "rule-based-scaffold-title-1-task-2": "",
        "rule-based-scaffold-title-1-task-3": "",
        ...
        "rule-based-scaffold-title-5-task-2": "",
        "rule-based-scaffold-title-5-task-3": "",
        "annotation-label-1": "→ Ghi chú",
        "annotation-label-2": "→ quan trọng",
        "annotation-label-3": "→ hữu ích",
        "annotation-label-4": "→ khái niệm",
        "annotation-label-5": "→ khó hiểu",
        "product-visual-title": "",
        "product-visual-close-btn": "",
        "process-visual-title": "",
        "process-visual-set-goal-label": "",
        ...
        "gpt-scaffold-chat-send-btn-text": "Ctrl + Enter",
        "multi-agents-send-btn-text": "Ctrl+Enter",
        "annotation-toolbar-btn-hint": "Bảng chú thích",
        "annotation-search-toolbar-btn-hint": "Công cụ tìm kiếm chú thích",
        "gpt-scaffold-toolbar-btn-hint": "→ Công cụ hướng dẫn",
        "essay-writing-toolbar-btn-hint": "→ Công cụ viết",
        "planner-toolbar-btn-hint": "Công cụ lập kế hoạch",
        "multi-agents-single-window-toolbar-btn-hint": "Trợ lý trò chuyện",
        "timer-toolbar-btn-hint": "Bộ hẹn giờ",
        "like-response-text": "Bạn có thích câu trả lời này không?",
        "annotation-tool-data-label": "Công cụ chú thích",
        "search-annotation-tool-data-label": "Công cụ tìm kiếm chú thích",
        "gpt-scaffold-tool-data-label": "→ Công cụ hướng dẫn",
        "process-visual-tool-data-label": "",
        "essay-product-visual-tool-data-label": "",
        "collaborate-writing-tool-data-label": "",
        "essay-writing-tool-data-label": "→ Công cụ viết",
        "math-tool-data-label": "",
        "planner-tool-data-label": "Công cụ lập kế hoạch",
        "checklist-tool-data-label": "",
        "multi-agents-single-window-tool-data-label": "Công cụ Chatbot",
        "dictionary-tool-data-label": "",
        "timer-tool-data-label": "Công cụ hẹn giờ",
        "questionnaire-tool-data-label": "",
        "chat-reminder-message": "Chatbot này hiện đã sẵn sàng cho bạn sử dụng. Bạn không được sử dụng chatbot để viết bài luận của mình.",
        "multi-agents-single-window-placeholder-text-multi": "",
        "multi-agents-single-window-placeholder-text-single": "Nhập nội dung để bắt đầu trò chuyện",
        "chat-reminder-message-title": "Thông báo nhắc nhở",
        "scaffolding-message-title": "Phản hồi về tiến độ hiện tại của bạn:",
        "scaffold-chat-reminder": "Chào bạn, bạn đã tương tác với chatbot một lúc rồi. Hãy quay lại nhiệm vụ chính nhé!",
    },
};
