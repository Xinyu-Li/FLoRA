...
//                }
    ...
    function listener_main_editor(){
        ...
        collaborateEditorMainDiv.onkeyup = function(e) {
            ...
            sendEventMessage("", getCurrentTimestamp(), "COLLABORATE", "KEYBOARD_STROKE", null, "COLLABORATE_INNER-EDITOR", "WRITE", "CHANGE_INPUT", "KEY:::" + eventValue.key + "---" + eventValue.code, e);
        ...
        collaborateEditorMainDiv.onmouseup = function(e) {
            ...
            sendEventMessage("", getCurrentTimestamp(), "COLLABORATE_ESSAY", "MOUSE_CLICK", subActionLabelMap["COLLABORATIVE_ESSAY_SELECT_TEXT"], "COLLABORATE_INNER-EDITOR", null, tempInstantEvent, tempEventValue, e);
        };

        collaborateEditorMainDiv.onblur = function (e) {
            console.log('collaborateEditorMainDiv onblur');
            tempInstantEvent = "BLUR";
            sendEventMessage("", getCurrentTimestamp(), "COLLABORATE_ESSAY", "MOUSE_CLICK", null, "COLLABORATE_INNER-EDITOR", null, tempInstantEvent, tempEventValue, e);
        };
...
//            }
    ...
    chatText.onmouseup = function(e) {
        ...
        sendEventMessage("", getCurrentTimestamp(), "COLLABORATE_ESSAY", "MOUSE_CLICK", null, "COLLABORATIVE_CHAT_CONTENT", null, chatTempInstantEvent, chatTempEventValue, e);
    }
    }
