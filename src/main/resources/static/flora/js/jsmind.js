...
!function (e, t) {
    ...
    const t = {
        left: -1, center: 0, right: 1, of: function (e) {
    ...
    const r = new class {
        ...
        file: {
            read: function (e, t) {
                ...
                var n;
                if ("function" == typeof r.w.Blob) n = new Blob([e], {type: t}); else {
                ...
                if (navigator.msSaveBlob) navigator.msSaveBlob(n, i); else {
                    var s = (r.w.URL || r.w.webkitURL).createObjectURL(n), a = r.c("a");
                    if ("download" in a) {
    ...
    class h {
        ...
        _move_node(e, i, n, o) {
            if (e && n) {
                ...
                if (e.parent.id != n) {
                    for (var a = e.parent.children, d = a.length; d--;) if (a[d].id == e.id) {
                        a.splice(d, 1);
                        break
                    }
                    let t = e.parent;
        ...
        remove_node(e) {
            ...
            t.length = 0;
            for (var n = e.parent, o = n.children, r = o.length; r--;) if (o[r].id == e.id) {
                o.splice(r, 1);
                break
            }
    ...
    const _ = {name: "jsMind", author: "hizzgdev@163.com", version: e}, u = {
        node_tree: {
            example: {meta: _, format: "node_tree", data: {id: "root", topic: "jsMind node_tree example"}},
            get_mind: function (e) {
                var t = u.node_tree, i = new h;
            ...
            _parse: function (e, t) {
                var i = u.node_tree, n = i._extract_data(t);
            ...
            _extract_subnode: function (e, i, n) {
                var o = u.node_tree, s = o._extract_data(n), r = null;
                i.isroot && (r = "left" == n.direction ? t.left : t.right);
                var a = e.add_node(i, n.id, n.topic, s, r, n.expanded);
                if (n.children) for (var d = n.children, l = 0; l < d.length; l++) o._extract_subnode(e, a, d[l])
            },
            ...
            example: {
                ...
                var t = u.node_array, i = new h;
                return i.name = e.meta.name, i.author = e.meta.author, i.version = e.meta.version, t._parse(i, e.data), i
            }, get_data: function (e) {
                var t = u.node_array, i = {};
                return i.meta = {
                    name: e.name,
                    author: e.author,
                    version: e.version
                ...
                var i = u.node_array, n = t.slice(0);
                n.reverse();
                var o = i._extract_root(e, n);
                o ? i._extract_subnode(e, o, n) : s.error("root node can not be found")
            }, _extract_root: function (e, t) {
                for (var i = u.node_array, n = t.length; n--;) if ("isroot" in t[n] && t[n].isroot) {
                    var o = t[n], s = i._extract_data(o), r = e.set_root(o.id, o.topic, s);
                    return t.splice(n, 1), r
                }
                return null
            }, _extract_subnode: function (e, i, n) {
                for (var o = u.node_array, s = n.length, r = null, a = null, d = 0; s--;) if ((r = n[s]).parentid == i.id) {
                    a = o._extract_data(r);
                    var l = null, h = r.direction;
                ...
                var n = u.node_array;
                if (e instanceof l) {
                    var o = {id: e.id, topic: e.topic, expanded: e.expanded};
            ...
            example: {
                ...
                var o = u.freemind, s = n.getAttribute("ID"), r = n.getAttribute("TEXT"), a = n.getAttribute("FOLDED");
                if (null == r) for (var d = n.childNodes, l = null, h = 0; h < d.length; h++) if (1 == (l = d[h]).nodeType && "richcontent" === l.tagName) {
                    r = l.textContent;
                    break
                }
                var _ = o._load_attributes(n), c = "expanded" in _ ? "true" == _.expanded : "true" != a;
                delete _.expanded;
                var p = n.getAttribute("POSITION"), v = null;
                p && (v = "left" == p ? t.left : t.right);
                var f = null;
                f = i ? e.add_node(i, s, r, _, v, c) : e.set_root(s, r, _);
                var g = n.childNodes, m = null;
                ...
                var s = e.data;
                if (null != s) for (var r in s) i.push('<attribute NAME="' + r + '" VALUE="' + s[r] + '"/>');
            ...
            example: {meta: _, format: "text", data: "jsMind text example\n node1\n  node1-sub\n  node1-sub\n node2"},
            _line_regex: /\s*/,
            get_mind: function (e) {
                var t = u.text, i = new h;
                i.name = e.meta.name, i.author = e.meta.author, i.version = e.meta.version;
                var n = e.data.split(/\n|\r/);
            ...
            _fill_nodes: function (e, t) {
                let i = [], n = 0;
                for (; n < t.length;) {
                    let o = t[n], s = o.match(/\s*/)[0].length, r = o.substr(s);
            ...
            get_data: function (e) {
                var t = u.text, i = {};
                i.meta = {name: e.name, author: e.author, version: e.version}, i.format = "text";
                let n = [];
    ...
    class p {
        ...
        _layout_direction_root() {
            var e = this.jm.mind.root, i = null;
            "layout" in e._data ? i = e._data.layout : (i = {}, e._data.layout = i);
            var n = e.children, o = n.length;
            if (i.direction = t.center, i.side_index = 0, this.isside) for (var s = o; s--;) this._layout_direction_side(n[s], t.right, s); else {
                s = o;
        ...
        layout_offset() {
            var e = this.jm.mind.root, i = e._data.layout;
        ...
        get_expander_point(e) {
            var i = this.get_node_point_out(e), n = {};
        ...
        expand_to_depth(e, t, i) {
            if (!(e < 1)) for (var n = t || this.jm.mind.root.children, o = i || 1, s = n.length, r = null; s--;) r = n[s], o < e && (r.expanded || this.expand_node(r), this.expand_to_depth(e, r.children, o + 1)), o == e && r.expanded && this.collapse_node(r)
        }
    ...
    class g {
        ...
        init_nodes() {
            var e = this.jm.mind.nodes, t = r.d.createDocumentFragment();
        ...
        update_node(e) {
            ...
            if (e.topic && this.render_node(i, e), this.layout.is_visible(e)) t.width = i.clientWidth, t.height = i.clientHeight; else {
        ...
        edit_node_begin(e) {
            if (e.topic) {
                ...
                var t = e._data.view.element, i = e.topic, n = getComputedStyle(t);
        ...
        show_nodes() {
            var e = this.jm.mind.nodes, t = null, i = null, n = null, o = null, s = this.get_view_offset();
        ...
        restore_selected_node_custom_style(e) {
            var t = e._data.view.element, i = e.data;
        ...
        center_node(e) {
            ...
            let t = e._data.view, i = this.e_panel.getBoundingClientRect(), n = t.abs_x + t.width / 2,
    ...
    class m {
        ...
        init() {
            for (var e in r.on(this.jm.view.e_panel, "keydown", this.handler.bind(this)), this.handles.addchild = this.handle_addchild, this.handles.addbrother = this.handle_addbrother, this.handles.editnode = this.handle_editnode, this.handles.delnode = this.handle_delnode, this.handles.toggle = this.handle_toggle, this.handles.up = this.handle_up, this.handles.down = this.handle_down, this.handles.left = this.handle_left, this.handles.right = this.handle_right, this.mapping) if (this.mapping[e] && e in this.handles) {
    ...
    class z {
        ...
        _show(e, t) {
            ...
            this.mind = this.data.load(n), this.mind ? (s.debug("data.load ok"), this.view.load(), s.debug("view.load ok"), this.layout.layout(), s.debug("layout.layout ok"), this.view.show(!t), s.debug("view.show ok"), this.invoke_event_handle(i.show, {data: [e]})) : s.error("data.load error")
        }
        ...
        add_node(e, n, o, r, a) {
            if (this.get_editable()) {
                var d = this.get_node(e), l = t.of(a);
        ...
        remove_node(e) {
            ...
            if (this.get_editable()) {
                if (e.isroot) return s.error("fail, can not remove root node"), !1;
                var n = e.id, o = e.parent.id, r = this.get_node(o);
        ...
        update_node(e, t) {
            if (this.get_editable()) if (a.text.is_empty(t)) s.warn("fail, topic can not be empty"); else {
        ...
        move_node(e, t, n, o) {
            if (this.get_editable()) {
                var r = this.get_node(e), a = this.mind.move_node(r, t, n, o);
        ...
        scroll_node_to_center(e) {
            if (l.is_node(e)) this.view.center_node(e); else {
                var t = this.get_node(e);
        ...
        find_node_before(e) {
            ...
            if (e.isroot) return null;
            var i = null;
            if (e.parent.isroot) for (var n = e.parent.children, o = null, r = null, a = 0; a < n.length; a++) r = n[a], e.direction === r.direction && (e.id === r.id && (i = o), o = r); else i = this.mind.get_node_before(e);
            return i
        }
        ...
        find_node_after(e) {
            ...
            var i = null;
            if (e.parent.isroot) {
                for (var n = e.parent.children, o = !1, r = null, a = 0; a < n.length; a++) if (r = n[a], e.direction === r.direction) {
                    if (o) {
                        i = r;
                        break
                    }
