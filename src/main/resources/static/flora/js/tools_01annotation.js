function render() {
        ...
        <div style="display: block; position: absolute; z-index: 10000;" id="annotation-toolbox-div">
            <div class="border rounded shadow position-absolute bg-white d-none" id="annotation-toolbox">
                <div class="d-flex flex-row" style="height:60px;min-width:600px;">
                    <button id="takenoteBtn" class="btn btn-outline-secondary btn-sm annotation-toolbox-label-btn" style="width: 96px; font-size: 11px; line-height: 1.1; white-space: normal; word-break: break-word; overflow-wrap: anywhere;">
    ...
    for (let i = 0; i < annotationLabelColors.length; i++) {
        annotationToolStartHtml += `<button class="btn btn-outline-secondary btn-sm annotation-toolbox-label-btn" style="min-width: ${tagButtonLength}px; font-size: 8pt; line-height: 1.1;">${annotationLabelIconHtmlArr[i]}<br/>${annotationLabelColors[i].annotationLabel}</button>`;
    }
...
showSearchAnnotationsBtn.onclick = function(e) {
    ...
    activatePanelGeneral(collapseSearch);
