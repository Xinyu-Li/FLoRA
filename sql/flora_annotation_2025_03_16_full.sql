...
create table if not exists config_annotation_label_color
(
    id                          bigint auto_increment
    primary key,
...
create table if not exists config_generico_template
(
    id                                                       bigint auto_increment
    primary key,
...
create table if not exists config_gpt_scaffold_sub_action_or_srl_process
(
    id                                      bigint auto_increment
    primary key,
...
create table if not exists config_isdimu_score_prompt
(
    id                          bigint auto_increment
    primary key,
    threshold                   int    null,
...
create table if not exists config_planner
(
    id                            bigint auto_increment
    primary key,
    config_generico_template_id   bigint       not null,
...
create table if not exists config_pretest_grade_prompt
(
    id                          bigint auto_increment
    primary key,
    threshold                   int    null,
...
create table if not exists config_rule_based_scaffold
(
    id                          bigint auto_increment
    primary key,
    trigger_number              int    null,
...
create table if not exists deleted_annotation
(
    id                  bigint       not null
    primary key,
...
create table if not exists dictionary_log
(
    id              bigint auto_increment
    primary key,
    user_id         bigint        null,
...
create table if not exists essay_product_goal
(
    id              bigint auto_increment
    primary key,
    user_id         bigint       not null,
...
create table if not exists flora_user
(
    id       bigint auto_increment
    primary key,
    username varchar(255) not null,
...
create table if not exists flora_user_login_token
(
    id          bigint auto_increment
    primary key,
...
create table if not exists gpt_scaffold
(
    id                    bigint auto_increment
    primary key,
    user_id               bigint       not null,
...
create table if not exists medical_consult_result
(
    id             bigint auto_increment
    primary key,
...
create table if not exists popup_questionnaire
(
    id               bigint auto_increment
    primary key,
    user_id          bigint       null,
...
create table if not exists rule_base_check_grammar
(
    id               bigint auto_increment
    primary key,
    user_id          bigint       null,
...
create table if not exists rule_base_integration_and_elaboration
(
    id         bigint auto_increment
    primary key,
    essay      text         null,
...
create table if not exists rule_base_originality
(
    id         bigint auto_increment
    primary key,
    user_id    bigint       null,
...
create table if not exists rule_base_writing_checklist
(
    id         bigint auto_increment
    primary key,
    user_id    bigint       null,
...
create table if not exists study_tool_config
(
    id          bigint auto_increment
    primary key,
...
create table if not exists trace_data_real_time_process
(
    id                    bigint auto_increment
    primary key,
    user_id               bigint       null,
...
create table if not exists user_chatgpt_log
(
    id                       bigint auto_increment
    primary key,
    user_id                  bigint                   null,
...
create table if not exists user_chatgpt_topic
(
    id                bigint auto_increment
    primary key,
...
create table if not exists user_data_management
(
    id                                        bigint auto_increment
    primary key,
...
create table if not exists user_start_time
(
    id              bigint auto_increment
    primary key,
    user_id         bigint       not null,
...
create table if not exists user_teacher_log
(
    id        bigint auto_increment
    primary key,
    user_id   bigint       null,
...
create table if not exists whole_page_annotation
(
    id                        bigint auto_increment
    primary key,
    url                       varchar(500) not null,
